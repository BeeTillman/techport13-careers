...
(function(v){'use strict';function P(a,b){b=b||Error;return function(){var d=arguments[0],c;c="["+(a?a+":":"")+d+"] http://errors.angularjs.xlts.dev/1.5.16/"+(a?a+"/":"")+d;for(d=1;d<arguments.length;d++){c=c+(1==d?"?":"&")+"p"+(d-1)+"=";var f=encodeURIComponent,e;e=arguments[d];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;c+=f(e)}return new b(c)}}function na(a){if(null==a||Za(a))return!1;if(E(a)||x(a)||B&&a instanceof
B)return!0;var b="length"in Object(a)&&a.length;return ca(b)&&(0<=b&&(b-1 in a||a instanceof Array)||"function"===typeof a.item)}function q(a,b,d){var c,f;if(a)if(A(a))for(c in a)"prototype"===c||"length"===c||"name"===c||a.hasOwnProperty&&!a.hasOwnProperty(c)||b.call(d,a[c],c,a);else if(E(a)||na(a)){var e="object"!==typeof a;c=0;for(f=a.length;c<f;c++)(e||c in a)&&b.call(d,a[c],c,a)}else if(a.forEach&&a.forEach!==q)a.forEach(b,d,a);else if(Ac(a))for(c in a)b.call(d,a[c],c,a);else if("function"===
typeof a.hasOwnProperty)for(c in a)a.hasOwnProperty(c)&&b.call(d,a[c],c,a);else for(c in a)xa.call(a,c)&&b.call(d,a[c],c,a);return a}function Bc(a,b,d){for(var c=Object.keys(a).sort(),f=0;f<c.length;f++)b.call(d,a[c[f]],c[f]);return c}function Cc(a){return function(b,d){a(d,b)}}function pe(){return++ub}function Tb(a,b,d){for(var c=a.$$hashKey,f=0,e=b.length;f<e;++f){var g=b[f];if(G(g)||A(g))for(var h=Object.keys(g),k=0,l=h.length;k<l;k++){var m=h[k],n=g[m];d&&G(n)?fa(n)?a[m]=new Date(n.valueOf()):
$a(n)?a[m]=new RegExp(n):n.nodeName?a[m]=n.cloneNode(!0):Ub(n)?a[m]=n.clone():"__proto__"!==m&&(G(a[m])||(a[m]=E(n)?[]:{}),Tb(a[m],[n],!0)):a[m]=n}}c?a.$$hashKey=c:delete a.$$hashKey;return a}function T(a){return Tb(a,ya.call(arguments,1),!1)}function qe(a){return Tb(a,ya.call(arguments,1),!0)}function Z(a){return parseInt(a,10)}function Vb(a,b){return T(Object.create(a),b)}function C(){}function ab(a){return a}function ia(a){return function(){return a}}function Dc(a){return A(a.toString)&&a.toString!==
oa}function z(a){return"undefined"===typeof a}function w(a){return"undefined"!==typeof a}function G(a){return null!==a&&"object"===typeof a}function Ac(a){return null!==a&&"object"===typeof a&&!Ec(a)}function x(a){return"string"===typeof a}function ca(a){return"number"===typeof a}function fa(a){return"[object Date]"===oa.call(a)}function A(a){return"function"===typeof a}function $a(a){return"[object RegExp]"===oa.call(a)}function Za(a){return a&&a.window===a}function bb(a){return a&&a.$evalAsync&&
a.$watch}function La(a){return"boolean"===typeof a}function re(a){return a&&ca(a.length)&&se.test(oa.call(a))}function Ub(a){return!(!a||!(a.nodeName||a.prop&&a.attr&&a.find))}function te(a){var b={};a=a.split(",");var d;for(d=0;d<a.length;d++)b[a[d]]=!0;return b}function va(a){return R(a.nodeName||a[0]&&a[0].nodeName)}function cb(a,b){var d=a.indexOf(b);0<=d&&a.splice(d,1);return d}function ta(a,b){function d(a,b){var d=b.$$hashKey,e;if(E(a)){e=0;for(var f=a.length;e<f;e++)b.push(c(a[e]))}else if(Ac(a))for(e in a)b[e]=
c(a[e]);else if(a&&"function"===typeof a.hasOwnProperty)for(e in a)a.hasOwnProperty(e)&&(b[e]=c(a[e]));else for(e in a)xa.call(a,e)&&(b[e]=c(a[e]));d?b.$$hashKey=d:delete b.$$hashKey;return b}function c(a){if(!G(a))return a;var b=e.indexOf(a);if(-1!==b)return g[b];if(Za(a)||bb(a))throw za("cpws");var b=!1,c=f(a);void 0===c&&(c=E(a)?[]:Object.create(Ec(a)),b=!0);e.push(a);g.push(c);return b?d(a,c):c}function f(a){switch(oa.call(a)){case "[object Int8Array]":case "[object Int16Array]":case "[object Int32Array]":case "[object Float32Array]":case "[object Float64Array]":case "[object Uint8Array]":case "[object Uint8ClampedArray]":case "[object Uint16Array]":case "[object Uint32Array]":return new a.constructor(c(a.buffer),
...
var e=[],g=[];if(b){if(re(b)||"[object ArrayBuffer]"===oa.call(b))throw za("cpta");if(a===b)throw za("cpi");E(b)?b.length=0:q(b,function(a,c){"$$hashKey"!==c&&delete b[c]});e.push(a);g.push(b);return d(a,b)}return c(a)}function pa(a,b){if(a===b)return!0;if(null===a||null===b)return!1;if(a!==a&&b!==b)return!0;var d=typeof a,c;if(d===typeof b&&"object"===d)if(E(a)){if(!E(b))return!1;if((d=a.length)===b.length){for(c=0;c<d;c++)if(!pa(a[c],b[c]))return!1;return!0}}else{if(fa(a))return fa(b)?pa(a.getTime(),
b.getTime()):!1;if($a(a))return $a(b)?a.toString()===b.toString():!1;if(bb(a)||bb(b)||Za(a)||Za(b)||E(b)||fa(b)||$a(b))return!1;d=W();for(c in a)if("$"!==c.charAt(0)&&!A(a[c])){if(!pa(a[c],b[c]))return!1;d[c]=!0}for(c in b)if(!(c in d)&&"$"!==c.charAt(0)&&w(b[c])&&!A(b[c]))return!1;return!0}return!1}function db(a,b,d){return a.concat(ya.call(b,d))}function eb(a,b){var d=2<arguments.length?ya.call(arguments,2):[];return!A(b)||b instanceof RegExp?b:d.length?function(){return arguments.length?b.apply(a,
db(d,arguments,0)):b.apply(a,d)}:function(){return arguments.length?b.apply(a,arguments):b.call(a)}}function ue(a,b){var d=b;"string"===typeof a&&"$"===a.charAt(0)&&"$"===a.charAt(1)?d=void 0:Za(b)?d="$WINDOW":b&&v.document===b?d="$DOCUMENT":bb(b)&&(d="$SCOPE");return d}function fb(a,b){if(!z(a))return ca(b)||(b=b?2:null),JSON.stringify(a,ue,b)}function Fc(a){return x(a)?JSON.parse(a):a}function Gc(a,b){a=a.replace(ve,"");var d=Date.parse("Jan 01, 1970 00:00:00 "+a)/6E4;return ja(d)?b:d}function Wb(a,
b,d){d=d?-1:1;var c=a.getTimezoneOffset();b=Gc(b,c);d*=b-c;a=new Date(a.getTime());a.setMinutes(a.getMinutes()+d);return a}function Aa(a){a=B(a).clone().empty();var b=B("<div>").append(a).html();try{return a[0].nodeType===Ma?R(b):b.match(/^(<[^>]+>)/)[1].replace(/^<([\w-]+)/,function(a,b){return"<"+R(b)})}catch(d){return R(b)}}function Hc(a){try{return decodeURIComponent(a)}catch(b){}}function Ic(a){var b={};q((a||"").split("&"),function(a){var c,f,e;a&&(f=a=a.replace(/\+/g,"%20"),c=a.indexOf("="),
-1!==c&&(f=a.substring(0,c),e=a.substring(c+1)),f=Hc(f),w(f)&&(e=w(e)?Hc(e):!0,xa.call(b,f)?E(b[f])?b[f].push(e):b[f]=[b[f],e]:b[f]=e))});return b}function Xb(a){var b=[];q(a,function(a,c){E(a)?q(a,function(a){b.push(qa(c,!0)+(!0===a?"":"="+qa(a,!0)))}):b.push(qa(c,!0)+(!0===a?"":"="+qa(a,!0)))});return b.length?b.join("&"):""}function vb(a){return qa(a,!0).replace(/%26/gi,"&").replace(/%3D/gi,"=").replace(/%2B/gi,"+")}function qa(a,b){return encodeURIComponent(a).replace(/%40/gi,"@").replace(/%3A/gi,
":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%3B/gi,";").replace(/%20/g,b?"%20":"+")}function we(a,b){var d,c,f=Pa.length;for(c=0;c<f;++c)if(d=Pa[c]+b,x(d=a.getAttribute(d)))return d;return null}function xe(a,b){var d,c,f={};q(Pa,function(b){b+="app";!d&&a.hasAttribute&&a.hasAttribute(b)&&(d=a,c=a.getAttribute(b))});q(Pa,function(b){b+="app";var f;!d&&(f=a.querySelector("["+b.replace(":","\\:")+"]"))&&(d=f,c=f.getAttribute(b))});d&&(ye?(f.strictDi=null!==we(d,"strict-di"),b(d,c?[c]:[],f)):
v.console.error("AngularJS: disabling automatic bootstrap. <script> protocol indicates an extension, document.location.href does not match."))}function Jc(a,b,d){G(d)||(d={});d=T({strictDi:!1},d);var c=function(){a=B(a);if(a.injector()){var c=a[0]===v.document?"document":Aa(a);throw za("btstrpd",c.replace(/</,"&lt;").replace(/>/,"&gt;"));}b=b||[];b.unshift(["$provide",function(b){b.value("$rootElement",a)}]);d.debugInfoEnabled&&b.push(["$compileProvider",function(a){a.debugInfoEnabled(!0)}]);b.unshift("ng");
c=gb(b,d.strictDi);c.invoke(["$rootScope","$rootElement","$compile","$injector",function(a,b,c,d){a.$apply(function(){b.data("$injector",d);c(b)(a)})}]);return c},f=/^NG_ENABLE_DEBUG_INFO!/,e=/^NG_DEFER_BOOTSTRAP!/;v&&f.test(v.name)&&(d.debugInfoEnabled=!0,v.name=v.name.replace(f,""));if(v&&!e.test(v.name))return c();v.name=v.name.replace(e,"");$.resumeBootstrap=function(a){q(a,function(a){b.push(a)});return c()};A($.resumeDeferredBootstrap)&&$.resumeDeferredBootstrap()}function ze(){v.name="NG_ENABLE_DEBUG_INFO!"+
v.name;v.location.reload()}function Ae(a){a=$.element(a).injector();if(!a)throw za("test");return a.get("$$testability")}function Kc(a,b){b=b||"_";return a.replace(Be,function(a,c){return(c?b:"")+a.toLowerCase()})}function Ce(){var a;if(!Lc){var b=wb();(Ba=z(b)?v.jQuery:b?v[b]:void 0)&&Ba.fn.on?(B=Ba,T(Ba.fn,{scope:Qa.scope,isolateScope:Qa.isolateScope,controller:Qa.controller,injector:Qa.injector,inheritedData:Qa.inheritedData}),a=Ba.cleanData,Ba.cleanData=function(b){for(var c,f=0,e;null!=(e=b[f]);f++)(c=
Ba._data(e,"events"))&&c.$destroy&&Ba(e).triggerHandler("$destroy");a(b)}):B=U;$.element=B;Lc=!0}}function De(){U.htmlPrefilter=function(a){var b=a.replace(Ee,"<$1></$2>");v.console&&v.console.warn&&a!==b&&v.console.warn("JQLite changed the HTML string:\n\n"+a+"\n\nto remove self-closing tags, resulting in this HTML string:\n\n"+b+"\n\nJQLite no longer does this replacement when you stop calling UNSAFE_restoreLegacyJqLiteXHTMLReplacement; please update your code to avoid self-closing tags.");return b}}
function hb(a,b,d){if(!a)throw za("areq",b||"?",d||"required");return a}function Ra(a,b,d){d&&E(a)&&(a=a[a.length-1]);hb(A(a),b,"not a function, got "+(a&&"object"===typeof a?a.constructor.name||"Object":typeof a));return a}function Sa(a,b){if("hasOwnProperty"===a)throw za("badname",b);}function Mc(a,b,d){if(!b)return a;b=b.split(".");for(var c,f=a,e=b.length,g=0;g<e;g++)c=b[g],a&&(a=(f=a)[c]);return!d&&A(a)?eb(f,a):a}function xb(a){for(var b=a[0],d=a[a.length-1],c,f=1;b!==d&&(b=b.nextSibling);f++)if(c||
a[f]!==b)c||(c=B(ya.call(a,0,f))),c.push(b);return c||a}function W(){return Object.create(null)}function Fe(a){function b(a,b,c){return a[b]||(a[b]=c())}var d=P("$injector"),c=P("ng");a=b(a,"angular",Object);a.$$minErr=a.$$minErr||P;return b(a,"module",function(){var a={};return function(e,g,h){if("hasOwnProperty"===e)throw c("badname","module");g&&a.hasOwnProperty(e)&&(a[e]=null);return b(a,e,function(){function a(b,d,e,f){f||(f=c);return function(){f[e||"push"]([b,d,arguments]);return H}}function b(a,
d){return function(b,f){f&&A(f)&&(f.$$moduleName=e);c.push([a,d,arguments]);return H}}if(!g)throw d("nomod",e);var c=[],f=[],r=[],s=a("$injector","invoke","push",f),H={_invokeQueue:c,_configBlocks:f,_runBlocks:r,requires:g,name:e,provider:b("$provide","provider"),factory:b("$provide","factory"),service:b("$provide","service"),value:a("$provide","value"),constant:a("$provide","constant","unshift"),decorator:b("$provide","decorator"),animation:b("$animateProvider","register"),filter:b("$filterProvider",
"register"),controller:b("$controllerProvider","register"),directive:b("$compileProvider","directive"),component:b("$compileProvider","component"),config:s,run:function(a){r.push(a);return this}};h&&s(h);return H})}})}function ma(a,b){if(E(a)){b=b||[];for(var d=0,c=a.length;d<c;d++)b[d]=a[d]}else if(G(a))for(d in b=b||{},a)if("$"!==d.charAt(0)||"$"!==d.charAt(1))b[d]=a[d];return b||a}function Ge(a){T(a,{bootstrap:Jc,copy:ta,extend:T,merge:qe,equals:pa,element:B,forEach:q,injector:gb,noop:C,bind:eb,
toJson:fb,fromJson:Fc,identity:ab,isUndefined:z,isDefined:w,isString:x,isFunction:A,isObject:G,isNumber:ca,isElement:Ub,isArray:E,version:He,isDate:fa,lowercase:R,uppercase:yb,callbacks:{$$counter:0},getTestability:Ae,UNSAFE_restoreLegacyJqLiteXHTMLReplacement:De,$$minErr:P,$$csp:aa,reloadWithDebugInfo:ze});Yb=Fe(v);Yb("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:Ie});a.provider("$compile",Nc).directive({a:Je,input:Oc,textarea:Oc,form:Ke,script:Le,select:Me,option:Ne,ngBind:Oe,
...
b){a.attr&&(a=a[0]);return Fb(a,b)},removeClass:function(a,b){a.attr&&(a=a[0]);return Eb(a,b)}})}}function Da(a,b){var d=a&&a.$$hashKey;if(d)return"function"===typeof d&&(d=a.$$hashKey()),d;d=typeof a;return d="function"===d||"object"===d&&null!==a?a.$$hashKey=d+":"+(b||pe)():d+":"+a}function Ta(a,b){if(b){var d=0;this.nextUid=function(){return++d}}q(a,this.put,this)}function dd(a){a=(Function.prototype.toString.call(a)+" ").replace(og,"");return a.match(pg)||a.match(qg)}function rg(a){return(a=dd(a))?
"function("+(a[1]||"").replace(/[\s\r\n]+/," ")+")":"fn"}function gb(a,b){function d(a){return function(b,c){if(G(b))q(b,Cc(a));else return a(b,c)}}function c(a,b){Sa(a,"service");if(A(b)||E(b))b=r.instantiate(b);if(!b.$get)throw Ea("pget",a);return n[a+"Provider"]=b}function f(a,b){return function(){var c=I.invoke(b,this);if(z(c))throw Ea("undef",a);return c}}function e(a,b,d){return c(a,{$get:!1!==d?f(a,b):b})}function g(a){hb(z(a)||E(a),"modulesToLoad","not an array");var b=[],c;q(a,function(a){function d(a){var b,
c;b=0;for(c=a.length;b<c;b++){var e=a[b],f=r.get(e[0]);f[e[1]].apply(f,e[2])}}if(!m.get(a)){m.put(a,!0);try{x(a)?(c=Yb(a),b=b.concat(g(c.requires)).concat(c._runBlocks),d(c._invokeQueue),d(c._configBlocks)):A(a)?b.push(r.invoke(a)):E(a)?b.push(r.invoke(a)):Ra(a,"module")}catch(e){throw E(a)&&(a=a[a.length-1]),e.message&&e.stack&&-1===e.stack.indexOf(e.message)&&(e=e.message+"\n"+e.stack),Ea("modulerr",a,e.stack||e.message||e);}}});return b}function h(a,c){function d(b,e){if(a.hasOwnProperty(b)){if(a[b]===
k)throw Ea("cdep",b+" <- "+l.join(" <- "));return a[b]}try{return l.unshift(b),a[b]=k,a[b]=c(b,e),a[b]}catch(f){throw a[b]===k&&delete a[b],f;}finally{l.shift()}}function e(a,c,f){var g=[];a=gb.$$annotate(a,b,f);for(var h=0,k=a.length;h<k;h++){var l=a[h];if("string"!==typeof l)throw Ea("itkn",l);g.push(c&&c.hasOwnProperty(l)?c[l]:d(l,f))}return g}return{invoke:function(a,b,c,d){"string"===typeof c&&(d=c,c=null);c=e(a,c,d);E(a)&&(a=a[a.length-1]);d=11>=Ca?!1:"function"===typeof a&&/^(?:class\b|constructor\()/.test(Function.prototype.toString.call(a)+
" ");return d?(c.unshift(null),new (Function.prototype.bind.apply(a,c))):a.apply(b,c)},instantiate:function(a,b,c){var d=E(a)?a[a.length-1]:a;a=e(a,b,c);a.unshift(null);return new (Function.prototype.bind.apply(d,a))},get:d,annotate:gb.$$annotate,has:function(b){return n.hasOwnProperty(b+"Provider")||a.hasOwnProperty(b)}}}b=!0===b;var k={},l=[],m=new Ta([],!0),n={$provide:{provider:d(c),factory:d(e),service:d(function(a,b){return e(a,["$injector",function(a){return a.instantiate(b)}])}),value:d(function(a,
b){return e(a,ia(b),!1)}),constant:d(function(a,b){Sa(a,"constant");n[a]=b;s[a]=b}),decorator:function(a,b){var c=r.get(a+"Provider"),d=c.$get;c.$get=function(){var a=I.invoke(d,c);return I.invoke(b,null,{$delegate:a})}}}},r=n.$injector=h(n,function(a,b){$.isString(b)&&l.push(b);throw Ea("unpr",l.join(" <- "));}),s={},H=h(s,function(a,b){var c=r.get(a+"Provider",b);return I.invoke(c.$get,c,void 0,a)}),I=H;n.$injectorProvider={$get:ia(H)};var p=g(a),I=H.get("$injector");I.strictDi=b;q(p,function(a){a&&
I.invoke(a)});return I}function sf(){var a=!0;this.disableAutoScrolling=function(){a=!1};this.$get=["$window","$location","$rootScope",function(b,d,c){function f(a){var b=null;Array.prototype.some.call(a,function(a){if("a"===va(a))return b=a,!0});return b}function e(a){if(a){a.scrollIntoView();var c;c=g.yOffset;A(c)?c=c():Ub(c)?(c=c[0],c="fixed"!==b.getComputedStyle(c).position?0:c.getBoundingClientRect().bottom):ca(c)||(c=0);c&&(a=a.getBoundingClientRect().top,b.scrollBy(0,a-c))}else b.scrollTo(0,
0)}function g(a){a=x(a)?a:ca(a)?a.toString():d.hash();var b;a?(b=h.getElementById(a))?e(b):(b=f(h.getElementsByName(a)))?e(b):"top"===a&&e(null):e(null)}var h=b.document;a&&c.$watch(function(){return d.hash()},function(a,b){a===b&&""===a||jg(function(){c.$evalAsync(g)})});return g}]}function mb(a,b){if(!a&&!b)return"";if(!a)return b;if(!b)return a;E(a)&&(a=a.join(" "));E(b)&&(b=b.join(" "));return a+" "+b}function sg(a){x(a)&&(a=a.split(" "));var b=W();q(a,function(a){a.length&&(b[a]=!0)});return b}
function Fa(a){return G(a)?a:{}}function tg(a,b,d,c){function f(a){try{a.apply(null,ya.call(arguments,1))}finally{if(H--,0===H)for(;I.length;)try{I.pop()()}catch(b){d.error(b)}}}function e(){M=null;g();h()}function g(){p=J();p=z(p)?null:p;pa(p,u)&&(p=u);u=p}function h(){if(y!==k.url()||N!==p)y=k.url(),N=p,q(D,function(a){a(k.url(),p)})}var k=this,l=a.location,m=a.history,n=a.setTimeout,r=a.clearTimeout,s={};k.isMock=!1;var H=0,I=[];k.$$completeOutstandingRequest=f;k.$$incOutstandingRequestCount=function(){H++};
k.notifyWhenNoOutstandingRequests=function(a){0===H?a():I.push(a)};var p,N,y=l.href,F=b.find("base"),M=null,J=c.history?function(){try{return m.state}catch(a){}}:C;g();N=p;k.url=function(b,d,e){z(e)&&(e=null);l!==a.location&&(l=a.location);m!==a.history&&(m=a.history);if(b){var f=N===e;if(y===b&&(!c.history||f))return k;var h=y&&Ja(y)===Ja(b);y=b;N=e;!c.history||h&&f?(h||(M=b),d?l.replace(b):h?(d=l,e=b.indexOf("#"),e=-1===e?"":b.substr(e),d.hash=e):l.href=b,l.href!==b&&(M=b)):(m[d?"replaceState":
"pushState"](e,"",b),g(),N=p);M&&(M=b);return k}return M||l.href.replace(/%27/g,"'")};k.state=function(){return p};var D=[],K=!1,u=null;k.onUrlChange=function(b){if(!K){if(c.history)B(a).on("popstate",e);B(a).on("hashchange",e);K=!0}D.push(b);return b};k.$$applicationDestroyed=function(){B(a).off("hashchange popstate",e)};k.$$checkUrlChange=h;k.baseHref=function(){var a=F.attr("href");return a?a.replace(/^(https?:)?\/\/[^/]*/,""):""};k.defer=function(a,b){var c;H++;c=n(function(){delete s[c];f(a)},
b||0);s[c]=!0;return c};k.defer.cancel=function(a){return s[a]?(delete s[a],r(a),f(C),!0):!1}}function zf(){this.$get=["$window","$log","$sniffer","$document",function(a,b,d,c){return new tg(a,c,b,d)}]}function Af(){this.$get=function(){function a(a,c){function f(a){a!==n&&(r?r===a&&(r=a.n):r=a,e(a.n,a.p),e(a,n),n=a,n.n=null)}function e(a,b){a!==b&&(a&&(a.p=b),b&&(b.n=a))}if(a in b)throw P("$cacheFactory")("iid",a);var g=0,h=T({},c,{id:a}),k=W(),l=c&&c.capacity||Number.MAX_VALUE,m=W(),n=null,r=null;
...
f};g[4]&&(n[a]=e[f])}});return e}function c(a){var b=a.charAt(0);if(!b||b!==R(b))throw ha("baddir",a);if(a!==a.trim())throw ha("baddir",a);}function f(a){var b=a.require||a.controller&&a.name;!E(b)&&G(b)&&q(b,function(a,c){var d=a.match(l);a.substring(d[0].length)||(b[c]=d[0]+c)});return b}var e={},g=/^\s*directive:\s*([\w-]+)\s+(.*)$/,h=/(([\w-]+)(?::([^;]+))?;?)/,k=te("ngSrc,ngSrcset,src,srcset"),l=/^(?:(\^\^?)?(\?)?(\^\^?)?)?/,m=/^(on[a-z]+|formaction)$/,n=W();this.directive=function y(b,d){hb(b,
"name");Sa(b,"directive");x(b)?(c(b),hb(d,"directiveFactory"),e.hasOwnProperty(b)||(e[b]=[],a.factory(b+"Directive",["$injector","$exceptionHandler",function(a,c){var d=[];q(e[b],function(e,g){try{var h=a.invoke(e);A(h)?h={compile:ia(h)}:!h.compile&&h.link&&(h.compile=ia(h.link));h.priority=h.priority||0;h.index=g;h.name=h.name||b;h.require=f(h);var k=h,l=h.restrict;if(l&&(!x(l)||!/[EACM]/.test(l)))throw ha("badrestrict",l,b);k.restrict=l||"EA";h.$$moduleName=e.$$moduleName;d.push(h)}catch(m){c(m)}});
return d}])),e[b].push(d)):q(b,Cc(y));return this};this.component=function(a,b){function c(a){function e(b){return A(b)||E(b)?function(c,d){return a.invoke(b,this,{$element:c,$attrs:d})}:b}var f=b.template||b.templateUrl?b.template:"",g={controller:d,controllerAs:ug(b.controller)||b.controllerAs||"$ctrl",template:e(f),templateUrl:e(b.templateUrl),transclude:b.transclude,scope:{},bindToController:b.bindings||{},restrict:"E",require:b.require};q(b,function(a,b){"$"===b.charAt(0)&&(g[b]=a)});return g}
var d=b.controller||function(){};q(b,function(a,b){"$"===b.charAt(0)&&(c[b]=a,A(d)&&(d[b]=a))});c.$inject=["$injector"];return this.directive(a,c)};this.aHrefSanitizationWhitelist=function(a){return w(a)?(b.aHrefSanitizationWhitelist(a),this):b.aHrefSanitizationWhitelist()};this.imgSrcSanitizationWhitelist=function(a){return w(a)?(b.imgSrcSanitizationWhitelist(a),this):b.imgSrcSanitizationWhitelist()};var r=!0;this.debugInfoEnabled=function(a){return w(a)?(r=a,this):r};var s=!0;this.preAssignBindingsEnabled=
function(a){return w(a)?(s=a,this):s};var H=10;this.onChangesTtl=function(a){return arguments.length?(H=a,this):H};var I=!0;this.commentDirectivesEnabled=function(a){return arguments.length?(I=a,this):I};var p=!0;this.cssClassDirectivesEnabled=function(a){return arguments.length?(p=a,this):p};this.$get=["$injector","$interpolate","$exceptionHandler","$templateRequest","$parse","$controller","$rootScope","$sce","$animate","$$sanitizeUri",function(a,b,c,f,n,K,u,Q,L,O){function ga(){try{if(!--za)throw aa=
...
c,d,e){a instanceof B||(a=B(a));for(var f=/\S+/,g=0,h=a.length;g<h;g++){var k=a[g];k.nodeType===Ma&&k.nodeValue.match(f)&&Xc(k,a[g]=v.document.createElement("span"))}var l=Na(a,b,a,c,d,e);da.$$addScopeClass(a);var m=null;return function(b,c,d){hb(b,"scope");e&&e.needsNewScope&&(b=b.$parent.$new());d=d||{};var f=d.parentBoundTranscludeFn,g=d.transcludeControllers;d=d.futureParentElement;f&&f.$$boundTransclude&&(f=f.$$boundTransclude);m||(m=(d=d&&d[0])?"foreignobject"!==va(d)&&oa.call(d).match(/SVG/)?
"svg":"html":"html");d="html"!==m?B(ia(m,B("<div>").append(a).html())):c?Qa.clone.call(a):a;if(g)for(var h in g)d.data("$"+h+"Controller",g[h].instance);da.$$addScopeInfo(d,b);c&&c(d,b);l&&l(b,d,d,f);return d}}function Na(a,b,c,d,e,f){function g(a,c,d,e){var f,k,l,m,n,p,y;if(s)for(y=Array(c.length),m=0;m<h.length;m+=3)f=h[m],y[f]=c[f];else y=c;m=0;for(n=h.length;m<n;)k=y[h[m++]],c=h[m++],f=h[m++],c?(c.scope?(l=a.$new(),da.$$addScopeInfo(B(k),l)):l=a,p=c.transcludeOnThisElement?la(a,c.transclude,e):
!c.templateOnThisElement&&e?e:!e&&b?la(a,b):null,c(f,l,k,d,p)):f&&f(a,k.childNodes,void 0,e)}for(var h=[],k,l,m,n,s,p=0;p<a.length;p++){k=new t;l=P(a[p],[],k,0===p?d:void 0,e);(f=l.length?U(l,a[p],k,b,c,null,[],[],f):null)&&f.scope&&da.$$addScopeClass(k.$$element);k=f&&f.terminal||!(m=a[p].childNodes)||!m.length?null:Na(m,f?(f.transcludeOnThisElement||!f.templateOnThisElement)&&f.transclude:b);if(f||k)h.push(p,f,k),n=!0,s=s||f;f=null}return n?g:null}function la(a,b,c){function d(e,f,g,h,k){e||(e=
a.$new(!1,k),e.$$transcluded=!0);return b(e,f,{parentBoundTranscludeFn:c,transcludeControllers:g,futureParentElement:h})}var e=d.$$slots=W(),f;for(f in b.$$slots)e[f]=b.$$slots[f]?la(a,b.$$slots[f],c):null;return d}function P(a,b,c,d,e){var f=c.$attr,g;switch(a.nodeType){case 1:g=va(a);V(b,Ga(g),"E",d,e);for(var k,l,m,n,p=a.attributes,s=0,y=p&&p.length;s<y;s++){var r=!1,L=!1;k=p[s];l=k.name;m=Y(k.value);k=Ga(l);(n=Ja.test(k))&&(l=l.replace(ed,"").substr(8).replace(/_(.)/g,function(a,b){return b.toUpperCase()}));
(k=k.match(Ka))&&Z(k[1])&&(r=l,L=l.substr(0,l.length-5)+"end",l=l.substr(0,l.length-6));k=Ga(l.toLowerCase());f[k]=l;if(n||!c.hasOwnProperty(k))c[k]=m,bd(a,k)&&(c[k]=!0);sa(a,b,m,k,n);V(b,k,"A",d,e,r,L)}"input"===g&&"hidden"===a.getAttribute("type")&&a.setAttribute("autocomplete","off");if(!Ia)break;f=a.className;G(f)&&(f=f.animVal);if(x(f)&&""!==f)for(;a=h.exec(f);)k=Ga(a[2]),V(b,k,"C",d,e)&&(c[k]=Y(a[3])),f=f.substr(a.index+a[0].length);break;case Ma:if(11===Ca)for(;a.parentNode&&a.nextSibling&&
a.nextSibling.nodeType===Ma;)a.nodeValue+=a.nextSibling.nodeValue,a.parentNode.removeChild(a.nextSibling);Ca&&a.parentNode&&"textarea"===va(a.parentNode)||ma(b,a.nodeValue);break;case 8:if(!Ha)break;Ua(a,b,c,d,e)}b.sort(fa);return b}function Ua(a,b,c,d,e){try{var f=g.exec(a.nodeValue);if(f){var h=Ga(f[1]);V(b,h,"M",d,e)&&(c[h]=Y(f[2]))}}catch(k){}}function fd(a,b,c){var d=[],e=0;if(b&&a.hasAttribute&&a.hasAttribute(b)){do{if(!a)throw ha("uterdir",b,c);1===a.nodeType&&(a.hasAttribute(b)&&e++,a.hasAttribute(c)&&
e--);d.push(a);a=a.nextSibling}while(0<e)}else d.push(a);return B(d)}function gd(a,b,c){return function(d,e,f,g,h){e=fd(e[0],b,c);return a(d,e,f,g,h)}}function ec(a,b,c,d,e,f){var g;return a?da(b,c,d,e,f):function(){g||(g=da(b,c,d,e,f),b=c=f=null);return g.apply(this,arguments)}}function U(a,b,d,e,f,g,h,k,l){function m(a,b,c,d){if(a){c&&(a=gd(a,c,d));a.require=u.require;a.directiveName=J;if(L===u||u.$$isolateScope)a=ra(a,{isolateScope:!0});h.push(a)}if(b){c&&(b=gd(b,c,d));b.require=u.require;b.directiveName=
J;if(L===u||u.$$isolateScope)b=ra(b,{isolateScope:!0});k.push(b)}}function n(a,e,f,g,l){function m(a,b,c,d){var e;bb(a)||(d=c,c=b,b=a,a=void 0);I&&(e=H);c||(c=I?K.parent():K);if(d){var f=l.$$slots[d];if(f)return f(a,b,e,c,S);if(z(f))throw ha("noslot",d,Aa(K));}else return l(a,b,e,c,S)}var p,u,D,O,F,H,J,K;b===f?(g=d,K=d.$$element):(K=B(f),g=new t(K,d));F=e;L?O=e.$new(!0):y&&(F=e.$parent);l&&(J=m,J.$$boundTransclude=l,J.isSlotFilled=function(a){return!!l.$$slots[a]});r&&(H=ca(K,g,J,r,O,e,L));L&&(da.$$addScopeInfo(K,
O,!0,!(Q&&(Q===L||Q===L.$$originalDirective))),da.$$addScopeClass(K,!0),O.$$isolateBindings=L.$$isolateBindings,u=na(e,g,O,O.$$isolateBindings,L),u.removeWatches&&O.$on("$destroy",u.removeWatches));for(p in H){u=r[p];D=H[p];var ga=u.$$bindings.bindToController;if(s){D.bindingInfo=ga?na(F,g,D.instance,ga,u):{};var cc=D();cc!==D.instance&&(D.instance=cc,K.data("$"+u.name+"Controller",cc),D.bindingInfo.removeWatches&&D.bindingInfo.removeWatches(),D.bindingInfo=na(F,g,D.instance,ga,u))}else D.instance=
D(),K.data("$"+u.name+"Controller",D.instance),D.bindingInfo=na(F,g,D.instance,ga,u)}q(r,function(a,b){var c=a.require;a.bindToController&&!E(c)&&G(c)&&T(H[b].instance,X(b,c,K,H))});q(H,function(a){var b=a.instance;if(A(b.$onChanges))try{b.$onChanges(a.bindingInfo.initialChanges)}catch(d){c(d)}if(A(b.$onInit))try{b.$onInit()}catch(e){c(e)}A(b.$doCheck)&&(F.$watch(function(){b.$doCheck()}),b.$doCheck());A(b.$onDestroy)&&F.$on("$destroy",function(){b.$onDestroy()})});p=0;for(u=h.length;p<u;p++)D=h[p],
ta(D,D.isolateScope?O:e,K,g,D.require&&X(D.directiveName,D.require,K,H),J);var S=e;L&&(L.template||null===L.templateUrl)&&(S=O);a&&a(S,f.childNodes,void 0,l);for(p=k.length-1;0<=p;p--)D=k[p],ta(D,D.isolateScope?O:e,K,g,D.require&&X(D.directiveName,D.require,K,H),J);q(H,function(a){a=a.instance;A(a.$postLink)&&a.$postLink()})}l=l||{};for(var p=-Number.MAX_VALUE,y=l.newScopeDirective,r=l.controllerDirectives,L=l.newIsolateScopeDirective,Q=l.templateDirective,D=l.nonTlbTranscludeDirective,O=!1,H=!1,
I=l.hasElementTranscludeDirective,F=d.$$element=B(b),u,J,K,ga=e,S,ua=!1,w=!1,v,x=0,C=a.length;x<C;x++){u=a[x];var Ua=u.$$start,Na=u.$$end;Ua&&(F=fd(b,Ua,Na));K=void 0;if(p>u.priority)break;if(v=u.scope)u.templateUrl||(G(v)?($("new/isolated scope",L||y,u,F),L=u):$("new/isolated scope",L,u,F)),y=y||u;J=u.name;if(!ua&&(u.replace&&(u.templateUrl||u.template)||u.transclude&&!u.$$tlb)){for(v=x+1;ua=a[v++];)if(ua.transclude&&!ua.$$tlb||ua.replace&&(ua.templateUrl||ua.template)){w=!0;break}ua=!0}!u.templateUrl&&
u.controller&&(r=r||W(),$("'"+J+"' controller",r[J],u,F),r[J]=u);if(v=u.transclude)if(O=!0,u.$$tlb||($("transclusion",D,u,F),D=u),"element"===v)I=!0,p=u.priority,K=F,F=d.$$element=B(da.$$createComment(J,d[J])),b=F[0],ka(f,ya.call(K,0),b),K[0].$$parentNode=K[0].parentNode,ga=ec(w,K,e,p,g&&g.name,{nonTlbTranscludeDirective:D});else{var la=W();K=B(ac(b)).contents();if(G(v)){K=[];var R=W(),V=W();q(v,function(a,b){var c="?"===a.charAt(0);a=c?a.substring(1):a;R[a]=b;la[b]=null;V[b]=c});q(F.contents(),function(a){var b=
R[Ga(va(a))];b?(V[b]=!0,la[b]=la[b]||[],la[b].push(a)):K.push(a)});q(V,function(a,b){if(!a)throw ha("reqslot",b);});for(var dc in la)la[dc]&&(la[dc]=ec(w,la[dc],e))}F.empty();ga=ec(w,K,e,void 0,void 0,{needsNewScope:u.$$isolateScope||u.$$newScope});ga.$$slots=la}if(u.template)if(H=!0,$("template",Q,u,F),Q=u,v=A(u.template)?u.template(F,d):u.template,v=Fa(v),u.replace){g=u;K=Zb.test(v)?hd(ia(u.templateNamespace,Y(v))):[];b=K[0];if(1!==K.length||1!==b.nodeType)throw ha("tplrt",J,"");ka(f,F,b);C={$attr:{}};
v=P(b,[],C);var Z=a.splice(x+1,a.length-(x+1));(L||y)&&ba(v,L,y);a=a.concat(v).concat(Z);ea(d,C);C=a.length}else F.html(v);if(u.templateUrl)H=!0,$("template",Q,u,F),Q=u,u.replace&&(g=u),n=ja(a.splice(x,a.length-x),F,d,f,O&&ga,h,k,{controllerDirectives:r,newScopeDirective:y!==u&&y,newIsolateScopeDirective:L,templateDirective:Q,nonTlbTranscludeDirective:D}),C=a.length;else if(u.compile)try{S=u.compile(F,d,ga);var aa=u.$$originalDirective||u;A(S)?m(null,eb(aa,S),Ua,Na):S&&m(eb(aa,S.pre),eb(aa,S.post),
Ua,Na)}catch(fa){c(fa,Aa(F))}u.terminal&&(n.terminal=!0,p=Math.max(p,u.priority))}n.scope=y&&!0===y.scope;n.transcludeOnThisElement=O;n.templateOnThisElement=H;n.transclude=ga;l.hasElementTranscludeDirective=I;return n}function X(a,b,c,d){var e;if(x(b)){var f=b.match(l);b=b.substring(f[0].length);var g=f[1]||f[3],f="?"===f[2];"^^"===g?c=c.parent():e=(e=d&&d[b])&&e.instance;if(!e){var h="$"+b+"Controller";e=g?c.inheritedData(h):c.data(h)}if(!e&&!f)throw ha("ctreq",b,a);}else if(E(b))for(e=[],g=0,f=
b.length;g<f;g++)e[g]=X(a,b[g],c,d);else G(b)&&(e={},q(b,function(b,f){e[f]=X(a,b,c,d)}));return e||null}function ca(a,b,c,d,e,f,g){var h=W(),k;for(k in d){var l=d[k],m={$scope:l===g||l.$$isolateScope?e:f,$element:a,$attrs:b,$transclude:c},n=l.controller;"@"===n&&(n=b[l.name]);m=K(n,m,!0,l.controllerAs);h[l.name]=m;a.data("$"+l.name+"Controller",m.instance)}return h}function ba(a,b,c){for(var d=0,e=a.length;d<e;d++)a[d]=Vb(a[d],{$$isolateScope:b,$$newScope:c})}function V(b,c,f,g,h,k,l){if(c===h)return null;
var m=null;if(e.hasOwnProperty(c)){h=a.get(c+"Directive");for(var n=0,p=h.length;n<p;n++)if(c=h[n],(z(g)||g>c.priority)&&-1!==c.restrict.indexOf(f)){k&&(c=Vb(c,{$$start:k,$$end:l}));if(!c.$$bindings){var s=m=c,r=c.name,L={isolateScope:null,bindToController:null};G(s.scope)&&(!0===s.bindToController?(L.bindToController=d(s.scope,r,!0),L.isolateScope={}):L.isolateScope=d(s.scope,r,!1));G(s.bindToController)&&(L.bindToController=d(s.bindToController,r,!0));if(L.bindToController&&!s.controller)throw ha("noctrl",
r);m=m.$$bindings=L;G(m.isolateScope)&&(c.$$isolateBindings=m.isolateScope)}b.push(c);m=c}}return m}function Z(b){if(e.hasOwnProperty(b))for(var c=a.get(b+"Directive"),d=0,f=c.length;d<f;d++)if(b=c[d],b.multiElement)return!0;return!1}function ea(a,b){var c=b.$attr,d=a.$attr;q(a,function(d,e){"$"!==e.charAt(0)&&(b[e]&&b[e]!==d&&(d+=("style"===e?";":" ")+b[e]),a.$set(e,d,!0,c[e]))});q(b,function(b,e){a.hasOwnProperty(e)||"$"===e.charAt(0)||(a[e]=b,"class"!==e&&"style"!==e&&(d[e]=c[e]))})}function ja(a,
b,c,d,e,g,h,k){var l=[],m,n,p=b[0],s=a.shift(),y=Vb(s,{templateUrl:null,transclude:null,replace:null,$$originalDirective:s}),r=A(s.templateUrl)?s.templateUrl(b,c):s.templateUrl,L=s.templateNamespace;b.empty();f(r).then(function(f){var u,D;f=Fa(f);if(s.replace){f=Zb.test(f)?hd(ia(L,Y(f))):[];u=f[0];if(1!==f.length||1!==u.nodeType)throw ha("tplrt",s.name,r);f={$attr:{}};ka(d,b,u);var Q=P(u,[],f);G(s.scope)&&ba(Q,!0);a=Q.concat(a);ea(c,f)}else u=p,b.html(f);a.unshift(y);m=U(a,u,c,e,b,s,g,h,k);q(d,function(a,
c){a===u&&(d[c]=b[0])});for(n=Na(b[0].childNodes,e);l.length;){f=l.shift();D=l.shift();var O=l.shift(),H=l.shift(),Q=b[0];if(!f.$$destroyed){if(D!==p){var F=D.className;k.hasElementTranscludeDirective&&s.replace||(Q=ac(u));ka(O,B(D),Q);ua(B(Q),F)}D=m.transcludeOnThisElement?la(f,m.transclude,H):H;m(n,f,Q,d,D)}}l=null});return function(a,b,c,d,e){a=e;b.$$destroyed||(l?l.push(b,c,d,a):(m.transcludeOnThisElement&&(a=la(b,m.transclude,e)),m(n,b,c,d,a)))}}function fa(a,b){var c=b.priority-a.priority;return 0!==
...
d,e,f){function g(b,c,e){!A(d.$onChanges)||c===e||c!==c&&e!==e||(aa||(a.$$postDigest(ga),aa=[]),m||(m={},aa.push(h)),m[b]&&(e=m[b].previousValue),m[b]=new Jb(e,c))}function h(){d.$onChanges(m);m=void 0}var k=[],l={},m;q(e,function(e,h){var m=e.attrName,p=e.optional,s,y,r,L;switch(e.mode){case "@":p||xa.call(c,m)||(d[h]=c[m]=void 0);p=c.$observe(m,function(a){if(x(a)||La(a))g(h,a,d[h]),d[h]=a});c.$$observers[m].$$scope=a;s=c[m];x(s)?d[h]=b(s)(a):La(s)&&(d[h]=s);l[h]=new Jb(fc,d[h]);k.push(p);break;
case "=":if(!xa.call(c,m)){if(p)break;c[m]=void 0}if(p&&!c[m])break;y=n(c[m]);L=y.literal?pa:function(a,b){return a===b||a!==a&&b!==b};r=y.assign||function(){s=d[h]=y(a);throw ha("nonassign",c[m],m,f.name);};s=d[h]=y(a);p=function(b){L(b,d[h])||(L(b,s)?r(a,b=d[h]):d[h]=b);return s=b};p.$stateful=!0;p=e.collection?a.$watchCollection(c[m],p):a.$watch(n(c[m],p),null,y.literal);k.push(p);break;case "<":if(!xa.call(c,m)){if(p)break;c[m]=void 0}if(p&&!c[m])break;y=n(c[m]);var u=y.literal,Q=d[h]=y(a);l[h]=
new Jb(fc,d[h]);p=a.$watch(y,function(a,b){if(b===a){if(b===Q||u&&pa(b,Q))return;b=Q}g(h,a,b);d[h]=a},u);k.push(p);break;case "&":y=c.hasOwnProperty(m)?n(c[m]):C;if(y===C&&p)break;d[h]=function(b){return y(a,b)}}});return{initialChanges:l,removeWatches:k.length&&function(){for(var a=0,b=k.length;a<b;++a)k[a]()}}}var Ba=/^\w/,wa=v.document.createElement("div"),Ha=I,Ia=p,za=H,aa;t.prototype={$normalize:Ga,$addClass:function(a){a&&0<a.length&&L.addClass(this.$$element,a)},$removeClass:function(a){a&&
0<a.length&&L.removeClass(this.$$element,a)},$updateClass:function(a,b){var c=id(a,b);c&&c.length&&L.addClass(this.$$element,c);(c=id(b,a))&&c.length&&L.removeClass(this.$$element,c)},$set:function(a,b,d,e){var f=bd(this.$$element[0],a),g=jd[a],h=a;f?(this.$$element.prop(a,b),e=f):g&&(this[g]=b,h=g);this[a]=b;e?this.$attr[a]=e:(e=this.$attr[a])||(this.$attr[a]=e=Kc(a,"-"));f=va(this.$$element);if("a"===f&&("href"===a||"xlinkHref"===a)||"img"===f&&"src"===a)this[a]=b=O(b,"src"===a);else if("img"===
...
d=c.$$observers||(c.$$observers=W()),e=d[a]||(d[a]=[]);e.push(b);u.$evalAsync(function(){e.$$inter||!c.hasOwnProperty(a)||z(c[a])||b(c[a])});return function(){cb(e,b)}}};var Da=b.startSymbol(),Ea=b.endSymbol(),Fa="{{"===Da&&"}}"===Ea?ab:function(a){return a.replace(/\{\{/g,Da).replace(/}}/g,Ea)},Ja=/^ngAttr[A-Z]/,Ka=/^(.+)Start$/;da.$$addBindingInfo=r?function(a,b){var c=a.data("$binding")||[];E(b)?c=c.concat(b):c.push(b);a.data("$binding",c)}:C;da.$$addBindingClass=r?function(a){ua(a,"ng-binding")}:
C;da.$$addScopeInfo=r?function(a,b,c,d){a.data(c?d?"$isolateScopeNoTemplate":"$isolateScope":"$scope",b)}:C;da.$$addScopeClass=r?function(a,b){ua(a,b?"ng-isolate-scope":"ng-scope")}:C;da.$$createComment=function(a,b){var c="";r&&(c=" "+(a||"")+": ",b&&(c+=b+" "));return v.document.createComment(c)};return da}]}function Jb(a,b){this.previousValue=a;this.currentValue=b}function Ga(a){return ib(a.replace(ed,""))}function id(a,b){var d="",c=a.split(/\s+/),f=b.split(/\s+/),e=0;a:for(;e<c.length;e++){for(var g=
c[e],h=0;h<f.length;h++)if(g===f[h])continue a;d+=(0<d.length?" ":"")+g}return d}function hd(a){a=B(a);var b=a.length;if(1>=b)return a;for(;b--;){var d=a[b];(8===d.nodeType||d.nodeType===Ma&&""===d.nodeValue.trim())&&vg.call(a,b,1)}return a}function ug(a,b){if(b&&x(b))return b;if(x(a)){var d=kd.exec(a);if(d)return d[3]}}function Bf(){var a={},b=!1;this.has=function(b){return a.hasOwnProperty(b)};this.register=function(b,c){Sa(b,"controller");G(b)?T(a,b):a[b]=c};this.allowGlobals=function(){b=!0};
this.$get=["$injector","$window",function(d,c){function f(a,b,c,d){if(!a||!G(a.$scope))throw P("$controller")("noscp",d,b);a.$scope[b]=c}return function(e,g,h,k){var l,m,n;h=!0===h;k&&x(k)&&(n=k);if(x(e)){k=e.match(kd);if(!k)throw ld("ctrlfmt",e);m=k[1];n=n||k[3];e=a.hasOwnProperty(m)?a[m]:Mc(g.$scope,m,!0)||(b?Mc(c,m,!0):void 0);if(!e)throw ld("ctrlreg",m);Ra(e,m,!0)}if(h)return h=(E(e)?e[e.length-1]:e).prototype,l=Object.create(h||null),n&&f(g,n,l,m||e.name),T(function(){var a=d.invoke(e,l,g,m);
a!==l&&(G(a)||A(a))&&(l=a,n&&f(g,n,l,m||e.name));return l},{instance:l,identifier:n});l=d.instantiate(e,g,m);n&&f(g,n,l,m||e.name);return l}}]}function Cf(){this.$get=["$window",function(a){return B(a.document)}]}function Df(){this.$get=["$log",function(a){return function(b,d){a.error.apply(a,arguments)}}]}function gc(a){return G(a)?fa(a)?a.toISOString():fb(a):a}function If(){this.$get=function(){return function(a){if(!a)return"";var b=[];Bc(a,function(a,c){null===a||z(a)||(E(a)?q(a,function(a){b.push(qa(c)+
"="+qa(gc(a)))}):b.push(qa(c)+"="+qa(gc(a))))});return b.join("&")}}}function Jf(){this.$get=function(){return function(a){function b(a,f,e){null===a||z(a)||(E(a)?q(a,function(a,c){b(a,f+"["+(G(a)?c:"")+"]")}):G(a)&&!fa(a)?Bc(a,function(a,c){b(a,f+(e?"":"[")+c+(e?"":"]"))}):d.push(qa(f)+"="+qa(gc(a))))}if(!a)return"";var d=[];b(a,"",!0);return d.join("&")}}}function hc(a,b){if(x(a)){var d=a.replace(wg,"").trim();if(d){var c=b("Content-Type");(c=c&&0===c.indexOf(md))||(c=(c=d.match(xg))&&yg[c[0]].test(d));
c&&(a=Fc(d))}}return a}function nd(a){var b=W(),d;x(a)?q(a.split("\n"),function(a){d=a.indexOf(":");var f=R(Y(a.substr(0,d)));a=Y(a.substr(d+1));f&&(b[f]=b[f]?b[f]+", "+a:a)}):G(a)&&q(a,function(a,d){var e=R(d),g=Y(a);e&&(b[e]=b[e]?b[e]+", "+g:g)});return b}function od(a){var b;return function(d){b||(b=nd(a));return d?(d=b[R(d)],void 0===d&&(d=null),d):b}}function pd(a,b,d,c){if(A(c))return c(a,b,d);q(c,function(c){a=c(a,b,d)});return a}function Hf(){var a=this.defaults={transformResponse:[hc],transformRequest:[function(a){return G(a)&&
...
m,!1);f.body.removeChild(e);e=null;var g=-1,s="unknown";a&&("load"!==a.type||c.wasCalled(b)||(a={type:"error"}),s=a.type,g="error"===a.type?404:200);d&&d(g,s)};e.addEventListener("load",m,!1);e.addEventListener("error",m,!1);f.body.appendChild(e);return m}return function(f,h,k,l,m,n,r,s,H,I){function p(){F&&F();M&&M.abort()}function N(b,c,e,f,g){w(D)&&d.cancel(D);F=M=null;b(c,e,f,g);a.$$completeOutstandingRequest(C)}a.$$incOutstandingRequestCount();h=h||a.url();if("jsonp"===R(f))var y=c.createCallback(h),
F=e(h,y,function(a,b){var d=200===a&&c.getResponse(y);N(l,a,d,"",b);c.removeCallback(y)});else{var M=b(f,h);M.open(f,h,!0);q(m,function(a,b){w(a)&&M.setRequestHeader(b,a)});M.onload=function(){var a=M.statusText||"",b="response"in M?M.response:M.responseText,c=1223===M.status?204:M.status;0===c&&(c=b?200:"file"===wa(h).protocol?404:0);N(l,c,b,M.getAllResponseHeaders(),a)};f=function(){N(l,-1,null,null,"")};M.onerror=f;M.onabort=f;M.ontimeout=f;q(H,function(a,b){M.addEventListener(b,a)});q(I,function(a,
b){M.upload.addEventListener(b,a)});r&&(M.withCredentials=!0);if(s)try{M.responseType=s}catch(J){if("json"!==s)throw J;}M.send(z(k)?null:k)}if(0<n)var D=d(p,n);else n&&A(n.then)&&n.then(p)}}function Ff(){var a="{{",b="}}";this.startSymbol=function(b){return b?(a=b,this):a};this.endSymbol=function(a){return a?(b=a,this):b};this.$get=["$parse","$exceptionHandler","$sce",function(d,c,f){function e(a){return"\\\\\\"+a}function g(c){return c.replace(n,a).replace(r,b)}function h(a,b,c,d){var e=a.$watch(function(a){e();
return d(a)},b,c);return e}function k(e,k,n,p){function r(a){try{var b=a;a=n?f.getTrusted(n,b):f.valueOf(b);var d;if(p&&!w(a))d=a;else if(null==a)d="";else{switch(typeof a){case "string":break;case "number":a=""+a;break;default:a=fb(a)}d=a}return d}catch(g){c(Ka.interr(e,g))}}if(!e.length||-1===e.indexOf(a)){var y;k||(k=g(e),y=ia(k),y.exp=e,y.expressions=[],y.$$watchDelegate=h);return y}p=!!p;var F,q,J=0,D=[],K=[];y=e.length;for(var u=[],Q=[];J<y;)if(-1!==(F=e.indexOf(a,J))&&-1!==(q=e.indexOf(b,F+
l)))J!==F&&u.push(g(e.substring(J,F))),J=e.substring(F+l,q),D.push(J),K.push(d(J,r)),J=q+m,Q.push(u.length),u.push("");else{J!==y&&u.push(g(e.substring(J)));break}n&&1<u.length&&Ka.throwNoconcat(e);if(!k||D.length){var L=function(a){for(var b=0,c=D.length;b<c;b++){if(p&&z(a[b]))return;u[Q[b]]=a[b]}return u.join("")};return T(function(a){var b=0,d=D.length,f=Array(d);try{for(;b<d;b++)f[b]=K[b](a);return L(f)}catch(g){c(Ka.interr(e,g))}},{exp:e,expressions:D,$$watchDelegate:function(a,b){var c;return a.$watchGroup(K,
function(d,e){var f=L(d);A(b)&&b.call(this,f,d!==e?c:f,a);c=f})}})}}var l=a.length,m=b.length,n=new RegExp(a.replace(/./g,e),"g"),r=new RegExp(b.replace(/./g,e),"g");k.startSymbol=function(){return a};k.endSymbol=function(){return b};return k}]}function Gf(){this.$get=["$rootScope","$window","$q","$$q","$browser",function(a,b,d,c,f){function e(e,k,l,m){function n(){r?e.apply(null,s):e(p)}var r=4<arguments.length,s=r?ya.call(arguments,4):[],H=b.setInterval,I=b.clearInterval,p=0,N=w(m)&&!m,y=(N?c:d).defer(),
F=y.promise;l=w(l)?l:0;F.$$intervalId=H(function(){N?f.defer(n):a.$evalAsync(n);y.notify(p++);0<l&&p>=l&&(y.resolve(p),I(F.$$intervalId),delete g[F.$$intervalId]);N||a.$apply()},k);g[F.$$intervalId]=y;return F}var g={};e.cancel=function(a){return a&&a.$$intervalId in g?(g[a.$$intervalId].reject("canceled"),b.clearInterval(a.$$intervalId),delete g[a.$$intervalId],!0):!1};return e}]}function kc(a){a=a.split("/");for(var b=a.length;b--;)a[b]=vb(a[b]);return a.join("/")}function sd(a,b){var d=wa(a);b.$$protocol=
...
b?a:a.substr(0,b)}function ob(a){return a.replace(/(#.+)|#$/,"$1")}function lc(a,b,d){this.$$html5=!0;d=d||"";sd(a,this);this.$$parse=function(a){var d=ra(b,a);if(!x(d))throw nb("ipthprfx",a,b);td(d,this);this.$$path||(this.$$path="/");this.$$compose()};this.$$compose=function(){var a=Xb(this.$$search),d=this.$$hash?"#"+vb(this.$$hash):"";this.$$url=kc(this.$$path)+(a?"?"+a:"")+d;this.$$absUrl=b+this.$$url.substr(1)};this.$$parseLinkUrl=function(c,f){if(f&&"#"===f[0])return this.hash(f.slice(1)),
...
f=this.$$hash?"#"+vb(this.$$hash):"";this.$$url=kc(this.$$path)+(b?"?"+b:"")+f;this.$$absUrl=a+d+this.$$url}}function Kb(a){return function(){return this[a]}}function vd(a,b){return function(d){if(z(d))return this[a];this[a]=b(d);this.$$compose();return this}}function Nf(){var a="",b={enabled:!1,requireBase:!0,rewriteLinks:!0};this.hashPrefix=function(b){return w(b)?(a=b,this):a};this.html5Mode=function(a){if(La(a))return b.enabled=a,this;if(G(a)){La(a.enabled)&&(b.enabled=a.enabled);La(a.requireBase)&&
(b.requireBase=a.requireBase);if(La(a.rewriteLinks)||x(a.rewriteLinks))b.rewriteLinks=a.rewriteLinks;return this}return b};this.$get=["$rootScope","$browser","$sniffer","$rootElement","$window",function(d,c,f,e,g){function h(a,b,d){var e=l.url(),f=l.$$state;try{c.url(a,b,d),l.$$state=c.state()}catch(g){throw l.url(e),l.$$state=f,g;}}function k(a,b){d.$broadcast("$locationChangeSuccess",l.absUrl(),a,l.$$state,b)}var l,m;m=c.baseHref();var n=c.url(),r;if(b.enabled){if(!m&&b.requireBase)throw nb("nobase");
r=n.substring(0,n.indexOf("/",n.indexOf("//")+2))+(m||"/");m=f.history?lc:ud}else r=Ja(n),m=mc;var s=r.substr(0,Ja(r).lastIndexOf("/")+1);l=new m(r,s,"#"+a);l.$$parseLinkUrl(n,n);l.$$state=c.state();var H=/^\s*(javascript|mailto):/i;e.on("click",function(a){var f=b.rewriteLinks;if(f&&!a.ctrlKey&&!a.metaKey&&!a.shiftKey&&2!==a.which&&2!==a.button){for(var g=B(a.target);"a"!==va(g[0]);)if(g[0]===e[0]||!(g=g.parent())[0])return;if(!x(f)||!z(g.attr(f))){var f=g.prop("href"),h=g.attr("href")||g.attr("xlink:href");
G(f)&&"[object SVGAnimatedString]"===f.toString()&&(f=wa(f.animVal).href);H.test(f)||!f||g.attr("target")||a.isDefaultPrevented()||!l.$$parseLinkUrl(f,h)||(a.preventDefault(),l.absUrl()!==c.url()&&d.$apply())}}});ob(l.absUrl())!==ob(n)&&c.url(l.absUrl(),!0);var I=!0;c.onUrlChange(function(a,b){z(ra(s,a))?g.location.href=a:(d.$evalAsync(function(){var c=l.absUrl(),e=l.$$state,f;a=ob(a);l.$$parse(a);l.$$state=b;f=d.$broadcast("$locationChangeStart",a,c,b,e).defaultPrevented;l.absUrl()===a&&(f?(l.$$parse(c),
l.$$state=e,h(c,!1,e)):(I=!1,k(c,e)))}),d.$$phase||d.$digest())});d.$watch(function(){var a=ob(c.url()),b=ob(l.absUrl()),e=c.state(),g=l.$$replace,m=a!==b||l.$$html5&&f.history&&e!==l.$$state;if(I||m)I=!1,d.$evalAsync(function(){var b=l.absUrl(),c=d.$broadcast("$locationChangeStart",b,a,l.$$state,e).defaultPrevented;l.absUrl()===b&&(c?(l.$$parse(a),l.$$state=e):(m&&h(b,g,e===l.$$state?null:l.$$state),k(a,e)))});l.$$replace=!1});return l}]}function Of(){var a=!0,b=this;this.debugEnabled=function(b){return w(b)?
(a=b,this):a};this.$get=["$window",function(d){function c(a){a instanceof Error&&(a.stack?a=a.message&&-1===a.stack.indexOf(a.message)?"Error: "+a.message+"\n"+a.stack:a.stack:a.sourceURL&&(a=a.message+"\n"+a.sourceURL+":"+a.line));return a}function f(a){var b=d.console||{},f=b[a]||b.log||C;a=!1;try{a=!!f.apply}catch(k){}return a?function(){var a=[];q(arguments,function(b){a.push(c(b))});return f.apply(b,a)}:function(a,b){f(a,null==b?"":b)}}return{log:f("log"),info:f("info"),warn:f("warn"),error:f("error"),
...
a.inputs:[a]);return c}var H=aa().noUnsafeEval,I={csp:H,expensiveChecks:!1,literals:ta(d),isIdentifierStart:A(c)&&c,isIdentifierContinue:A(f)&&f},p={csp:H,expensiveChecks:!0,literals:ta(d),isIdentifierStart:A(c)&&c,isIdentifierContinue:A(f)&&f},N=!1;g.$$runningExpensiveChecks=function(){return N};return g}]}function Rf(){this.$get=["$rootScope","$exceptionHandler",function(a,b){return Ld(function(b){a.$evalAsync(b)},b)}]}function Sf(){this.$get=["$browser","$exceptionHandler",function(a,b){return Ld(function(b){a.defer(b)},
b)}]}function Ld(a,b){function d(){var a=new g;a.resolve=f(a,a.resolve);a.reject=f(a,a.reject);a.notify=f(a,a.notify);return a}function c(){this.$$state={status:0}}function f(a,b){return function(c){b.call(a,c)}}function e(c){!c.processScheduled&&c.pending&&(c.processScheduled=!0,a(function(){var a,d,e;e=c.pending;c.processScheduled=!1;c.pending=void 0;for(var f=0,g=e.length;f<g;++f){d=e[f][0];a=e[f][c.status];try{A(a)?d.resolve(a(c.value)):1===c.status?d.resolve(c.value):d.reject(c.value)}catch(h){d.reject(h),
b(h)}}}))}function g(){this.promise=new c}function h(a){var b=new g;b.reject(a);return b.promise}function k(a,b,c){var d=null;try{A(c)&&(d=c())}catch(e){return h(e)}return d&&A(d.then)?d.then(function(){return b(a)},h):b(a)}function l(a,b,c,d){var e=new g;e.resolve(a);return e.promise.then(b,c,d)}function m(a){if(!A(a))throw n("norslvr",a);var b=new g;a(function(a){b.resolve(a)},function(a){b.reject(a)});return b.promise}var n=P("$q",TypeError);T(c.prototype,{then:function(a,b,c){if(z(a)&&z(b)&&z(c))return this;
...
(k=!0,h.$$reject(a))}var g,h=this,k=!1;try{if(G(a)||A(a))g=a&&a.then;A(g)?(this.promise.$$state.status=-1,g.call(a,c,d,f(this,this.notify))):(this.promise.$$state.value=a,this.promise.$$state.status=1,e(this.promise.$$state))}catch(l){d(l),b(l)}},reject:function(a){this.promise.$$state.status||this.$$reject(a)},$$reject:function(a){this.promise.$$state.value=a;this.promise.$$state.status=2;e(this.promise.$$state)},notify:function(c){var d=this.promise.$$state.pending;0>=this.promise.$$state.status&&
d&&d.length&&a(function(){for(var a,e,f=0,g=d.length;f<g;f++){e=d[f][0];a=d[f][3];try{e.notify(A(a)?a(c):c)}catch(h){b(h)}}})}});var r=l;m.prototype=c.prototype;m.defer=d;m.reject=h;m.when=l;m.resolve=r;m.all=function(a){var b=new g,c=0,d=E(a)?[]:{};q(a,function(a,e){c++;l(a).then(function(a){d[e]=a;--c||b.resolve(d)},function(a){b.reject(a)})});0===c&&b.resolve(d);return b.promise};m.race=function(a){var b=d();q(a,function(a){l(a).then(b.resolve,b.reject)});return b.promise};return m}function ag(){this.$get=
...
this.$parent=this.$$watchers=this.$$nextSibling=this.$$prevSibling=this.$$childHead=this.$$childTail=null;this.$root=this;this.$$destroyed=!1;this.$$listeners={};this.$$listenerCount={};this.$$watchersCount=0;this.$$isolateBindings=null}function n(a){if(N.$$phase)throw d("inprog",N.$$phase);N.$$phase=a}function r(a,b){do a.$$watchersCount+=b;while(a=a.$parent)}function s(a,b,c){do a.$$listenerCount[c]-=b,0===a.$$listenerCount[c]&&delete a.$$listenerCount[c];while(a=a.$parent)}function H(){}function I(){for(;t.length;)try{t.shift()()}catch(a){e(a)}f=
null}function p(){null===f&&(f=h.defer(function(){N.$apply(I)}))}m.prototype={constructor:m,$new:function(b,c){var d;c=c||this;b?(d=new m,d.$root=this.$root):(this.$$ChildScope||(this.$$ChildScope=a(this)),d=new this.$$ChildScope);d.$parent=c;d.$$prevSibling=c.$$childTail;c.$$childHead?(c.$$childTail.$$nextSibling=d,c.$$childTail=d):c.$$childHead=c.$$childTail=d;(b||c!==this)&&d.$on("$destroy",k);return d},$watch:function(a,b,d,e){var f=g(a);if(f.$$watchDelegate)return f.$$watchDelegate(this,b,d,
f,a);var h=this,k=h.$$watchers,l={fn:b,last:H,get:f,exp:e||a,eq:!!d};c=null;A(b)||(l.fn=C);k||(k=h.$$watchers=[],k.$$digestWatchIndex=-1);k.unshift(l);k.$$digestWatchIndex++;r(this,1);return function(){var a=cb(k,l);0<=a&&(r(h,-1),a<k.$$digestWatchIndex&&k.$$digestWatchIndex--);c=null}},$watchGroup:function(a,b){function c(){h=!1;k?(k=!1,b(e,e,g)):b(e,d,g)}var d=Array(a.length),e=Array(a.length),f=[],g=this,h=!1,k=!0;if(!a.length){var l=!0;g.$evalAsync(function(){l&&b(e,e,g)});return function(){l=
...
b)&&(a++,g=e[b],h=f[b],b in f?(d=h!==h&&g!==g,d||h===g||(l++,f[b]=g)):(s++,f[b]=g,l++));if(s>a)for(b in l++,f)xa.call(e,b)||(s--,delete f[b])}else f!==e&&(f=e,l++);return l}}c.$stateful=!0;var d=this,e,f,h,k=1<b.length,l=0,m=g(a,c),n=[],p={},r=!0,s=0;return this.$watch(m,function(){r?(r=!1,b(e,e,d)):b(e,h,d);if(k)if(G(e))if(na(e)){h=Array(e.length);for(var a=0;a<e.length;a++)h[a]=e[a]}else for(a in h={},e)xa.call(e,a)&&(h[a]=e[a]);else h=e})},$digest:function(){var a,g,k,l,m,p,r,s=b,q,t=[],M,w;n("$digest");
h.$$checkUrlChange();this===N&&null!==f&&(h.defer.cancel(f),I());c=null;do{r=!1;q=this;for(p=0;p<y.length;p++){try{w=y[p],w.scope.$eval(w.expression,w.locals)}catch(v){e(v)}c=null}y.length=0;a:do{if(p=q.$$watchers)for(p.$$digestWatchIndex=p.length;p.$$digestWatchIndex--;)try{if(a=p[p.$$digestWatchIndex])if(m=a.get,(g=m(q))!==(k=a.last)&&!(a.eq?pa(g,k):ja(g)&&ja(k)))r=!0,c=a,a.last=a.eq?ta(g,null):g,l=a.fn,l(g,k===H?g:k,q),5>s&&(M=4-s,t[M]||(t[M]=[]),t[M].push({msg:A(a.exp)?"fn: "+(a.exp.name||a.exp.toString()):
a.exp,newVal:g,oldVal:k}));else if(a===c){r=!1;break a}}catch(z){e(z)}if(!(p=q.$$watchersCount&&q.$$childHead||q!==this&&q.$$nextSibling))for(;q!==this&&!(p=q.$$nextSibling);)q=q.$parent}while(q=p);if((r||y.length)&&!s--)throw N.$$phase=null,d("infdig",b,t);}while(r||y.length);for(N.$$phase=null;J<F.length;)try{F[J++]()}catch(x){e(x)}F.length=J=0},$destroy:function(){if(!this.$$destroyed){var a=this.$parent;this.$broadcast("$destroy");this.$$destroyed=!0;this===N&&h.$$applicationDestroyed();r(this,
...
{};this.$$nextSibling=null;l(this)}},$eval:function(a,b){return g(a)(this,b)},$evalAsync:function(a,b){N.$$phase||y.length||h.defer(function(){y.length&&N.$digest()});y.push({scope:this,expression:g(a),locals:b})},$$postDigest:function(a){F.push(a)},$apply:function(a){try{n("$apply");try{return this.$eval(a)}finally{N.$$phase=null}}catch(b){e(b)}finally{try{N.$digest()}catch(c){throw e(c),c;}}},$applyAsync:function(a){function b(){c.$eval(a)}var c=this;a&&t.push(b);a=g(a);p()},$on:function(a,b){var c=
...
1),h--,k--;if(!(d=c.$$listenerCount[a]&&c.$$childHead||c!==this&&c.$$nextSibling))for(;c!==this&&!(d=c.$$nextSibling);)c=c.$parent}f.currentScope=null;return f}};var N=new m,y=N.$$asyncQueue=[],F=N.$$postDigestQueue=[],t=N.$$applyAsyncQueue=[],J=0;return N}]}function Ie(){var a=/^\s*(https?|ftp|mailto|tel|file):/,b=/^\s*((https?|ftp|file|blob):|data:image\/)/;this.aHrefSanitizationWhitelist=function(b){return w(b)?(a=b,this):a};this.imgSrcSanitizationWhitelist=function(a){return w(a)?(b=a,this):b};
this.$get=function(){return function(d,c){var f=c?b:a,e;e=wa(d&&d.trim()).href;return""===e||e.match(f)?d:"unsafe:"+e}}}function Mg(a){if("self"===a)return a;if(x(a)){if(-1<a.indexOf("***"))throw Ia("iwcard",a);a=Md(a).replace(/\\\*\\\*/g,".*").replace(/\\\*/g,"[^:/.?&;]*");return new RegExp("^"+a+"$")}if($a(a))return new RegExp("^"+a.source+"$");throw Ia("imatcher");}function Nd(a){var b=[];w(a)&&q(a,function(a){b.push(Mg(a))});return b}function Uf(){this.SCE_CONTEXTS=sa;var a=["self"],b=[];this.resourceUrlWhitelist=
...
"$document",function(a,b){var d={},c=!(a.chrome&&(a.chrome.app&&a.chrome.app.runtime||!a.chrome.app&&a.chrome.runtime&&a.chrome.runtime.id))&&a.history&&a.history.pushState,f=Z((/android (\d+)/.exec(R((a.navigator||{}).userAgent))||[])[1]),e=/Boxee/i.test((a.navigator||{}).userAgent),g=b[0]||{},h,k=/^(Moz|webkit|ms)(?=[A-Z])/,l=g.body&&g.body.style,m=!1,n=!1;if(l){for(var r in l)if(m=k.exec(r)){h=m[0];h=h[0].toUpperCase()+h.substr(1);break}h||(h="WebkitOpacity"in l&&"webkit");m=!!("transition"in l||
h+"Transition"in l);n=!!("animation"in l||h+"Animation"in l);!f||m&&n||(m=x(l.webkitTransition),n=x(l.webkitAnimation))}return{history:!(!c||4>f||e),hasEvent:function(a){if("input"===a&&11>=Ca)return!1;if(z(d[a])){var b=g.createElement("div");d[a]="on"+a in b}return d[a]},csp:aa(),vendorPrefix:h,transitions:m,animations:n,android:f}}]}function Xf(){var a;this.httpOptions=function(b){return b?(a=b,this):a};this.$get=["$templateCache","$http","$q","$sce",function(b,d,c,f){function e(g,h){e.totalPendingRequests++;
if(!x(g)||z(b.get(g)))g=f.getTrustedResourceUrl(g);var k=d.defaults&&d.defaults.transformResponse;E(k)?k=k.filter(function(a){return a!==hc}):k===hc&&(k=null);return d.get(g,T({cache:b,transformResponse:k},a))["finally"](function(){e.totalPendingRequests--}).then(function(a){b.put(g,a.data);return a.data},function(a){if(!h)throw Ng("tpload",g,a.status,a.statusText);return c.reject(a)})}e.totalPendingRequests=0;return e}]}function Yf(){this.$get=["$rootScope","$browser","$location",function(a,b,d){return{findBindings:function(a,
...
whenStable:function(a){b.notifyWhenNoOutstandingRequests(a)}}}]}function Zf(){this.$get=["$rootScope","$browser","$q","$$q","$exceptionHandler",function(a,b,d,c,f){function e(e,k,l){A(e)||(l=k,k=e,e=C);var m=ya.call(arguments,3),n=w(l)&&!l,r=(n?c:d).defer(),s=r.promise,q;q=b.defer(function(){try{r.resolve(e.apply(null,m))}catch(b){r.reject(b),f(b)}finally{delete g[s.$$timeoutId]}n||a.$apply()},k);s.$$timeoutId=q;g[q]=r;return s}var g={};e.cancel=function(a){return a&&a.$$timeoutId in g?(g[a.$$timeoutId].reject("canceled"),
delete g[a.$$timeoutId],b.defer.cancel(a.$$timeoutId)):!1};return e}]}function wa(a){Ca&&(ba.setAttribute("href",a),a=ba.href);ba.setAttribute("href",a);return{href:ba.href,protocol:ba.protocol?ba.protocol.replace(/:$/,""):"",host:ba.host,search:ba.search?ba.search.replace(/^\?/,""):"",hash:ba.hash?ba.hash.replace(/^#/,""):"",hostname:ba.hostname,port:ba.port,pathname:"/"===ba.pathname.charAt(0)?ba.pathname:"/"+ba.pathname}}function rd(a){a=x(a)?wa(a):a;return a.protocol===Od.protocol&&a.host===Od.host}
function $f(){this.$get=ia(v)}function Pd(a){function b(a){try{return decodeURIComponent(a)}catch(b){return a}}var d=a[0]||{},c={},f="";return function(){var a,g,h,k,l;try{a=d.cookie||""}catch(m){a=""}if(a!==f)for(f=a,a=f.split("; "),c={},h=0;h<a.length;h++)g=a[h],k=g.indexOf("="),0<k&&(l=b(g.substring(0,k)),z(c[l])&&(c[l]=b(g.substring(k+1))));return c}}function dg(){this.$get=Pd}function Uc(a){function b(d,c){if(G(d)){var f={};q(d,function(a,c){f[c]=b(c,a)});return f}return a.factory(d+"Filter",
c)}this.register=b;this.$get=["$injector",function(a){return function(b){return a.get(b+"Filter")}}];b("currency",Qd);b("date",Rd);b("filter",Og);b("json",Pg);b("limitTo",Qg);b("lowercase",Rg);b("number",Sd);b("orderBy",Td);b("uppercase",Sg)}function Og(){return function(a,b,d,c){if(!na(a)){if(null==a)return a;throw P("filter")("notarray",a);}c=c||"$";var f;switch(qc(b)){case "function":break;case "boolean":case "null":case "number":case "string":f=!0;case "object":b=Tg(b,d,c,f);break;default:return a}return Array.prototype.filter.call(a,
b)}}function Tg(a,b,d,c){var f=G(a)&&d in a;!0===b?b=pa:A(b)||(b=function(a,b){if(z(a))return!1;if(null===a||null===b)return a===b;if(G(b)||G(a)&&!Dc(a))return!1;a=R(""+a);b=R(""+b);return-1!==a.indexOf(b)});return function(e){return f&&!G(e)?Oa(e,a[d],b,d,!1):Oa(e,a,b,d,c)}}function Oa(a,b,d,c,f,e){var g=qc(a),h=qc(b);if("string"===h&&"!"===b.charAt(0))return!Oa(a,b.substring(1),d,c,f);if(E(a))return a.some(function(a){return Oa(a,b,d,c,f)});switch(g){case "object":var k;if(f){for(k in a)if("$"!==
k.charAt(0)&&Oa(a[k],b,d,c,!0))return!0;return e?!1:Oa(a,b,d,c,!1)}if("object"===h){for(k in b)if(e=b[k],!A(e)&&!z(e)&&(g=k===c,!Oa(g?a:a[k],e,d,c,g,g)))return!1;return!0}return d(a,b);case "function":return!1;default:return d(a,b)}}function qc(a){return null===a?"null":typeof a}function Qd(a){var b=a.NUMBER_FORMATS;return function(a,c,f){z(c)&&(c=b.CURRENCY_SYM);z(f)&&(f=b.PATTERNS[1].maxFrac);return null==a?a:Ud(a,b.PATTERNS[1],b.GROUP_SEP,b.DECIMAL_SEP,f).replace(/\u00A4/g,c)}}function Sd(a){var b=
a.NUMBER_FORMATS;return function(a,c){return null==a?a:Ud(a,b.PATTERNS[0],b.GROUP_SEP,b.DECIMAL_SEP,c)}}function Ug(a){var b=0,d,c,f,e,g;-1<(c=a.indexOf(Vd))&&(a=a.replace(Vd,""));0<(f=a.search(/e/i))?(0>c&&(c=f),c+=+a.slice(f+1),a=a.substring(0,f)):0>c&&(c=a.length);for(f=0;a.charAt(f)===rc;f++);if(f===(g=a.length))d=[0],c=1;else{for(g--;a.charAt(g)===rc;)g--;c-=f;d=[];for(e=0;f<=g;f++,e++)d[e]=+a.charAt(f)}c>Wd&&(d=d.splice(0,Wd-1),b=c-1,c=1);return{d:d,e:b,i:c}}function Vg(a,b,d,c){var f=a.d,e=
f.length-a.i;b=z(b)?Math.min(Math.max(d,e),c):+b;d=b+a.i;c=f[d];if(0<d){f.splice(Math.max(a.i,d));for(var g=d;g<f.length;g++)f[g]=0}else for(e=Math.max(0,e),a.i=1,f.length=Math.max(1,d=b+1),f[0]=0,g=1;g<d;g++)f[g]=0;if(5<=c)if(0>d-1){for(c=0;c>d;c--)f.unshift(0),a.i++;f.unshift(1);a.i++}else f[d-1]++;for(;e<Math.max(0,b);e++)f.push(0);if(b=f.reduceRight(function(a,b,c,d){b+=a;d[c]=b%10;return Math.floor(b/10)},0))f.unshift(b),a.i++}function Ud(a,b,d,c,f){if(!x(a)&&!ca(a)||isNaN(a))return"";var e=
!isFinite(a),g=!1,h=Math.abs(a)+"",k="";if(e)k="\u221e";else{g=Ug(h);Vg(g,f,b.minFrac,b.maxFrac);k=g.d;h=g.i;f=g.e;e=[];for(g=k.reduce(function(a,b){return a&&!b},!0);0>h;)k.unshift(0),h++;0<h?e=k.splice(h,k.length):(e=k,k=[0]);h=[];for(k.length>=b.lgSize&&h.unshift(k.splice(-b.lgSize,k.length).join(""));k.length>b.gSize;)h.unshift(k.splice(-b.gSize,k.length).join(""));k.length&&h.unshift(k.join(""));k=h.join(d);e.length&&(k+=c+e.join(""));f&&(k+="e+"+f)}return 0>a&&!g?b.negPre+k+b.negSuf:b.posPre+
k+b.posSuf}function Ob(a,b,d,c){var f="";if(0>a||c&&0>=a)c?a=-a+1:(a=-a,f="-");for(a=""+a;a.length<b;)a=rc+a;d&&(a=a.substr(a.length-b));return f+a}function V(a,b,d,c,f){d=d||0;return function(e){e=e["get"+a]();if(0<d||e>-d)e+=d;0===e&&-12===d&&(e=12);return Ob(e,b,c,f)}}function pb(a,b,d){return function(c,f){var e=c["get"+a](),g=yb((d?"STANDALONE":"")+(b?"SHORT":"")+a);return f[g][e]}}function Xd(a){var b=(new Date(a,0,1)).getDay();return new Date(a,0,(4>=b?5:12)-b)}function Yd(a){return function(b){var d=
Xd(b.getFullYear());b=+new Date(b.getFullYear(),b.getMonth(),b.getDate()+(4-b.getDay()))-+d;b=1+Math.round(b/6048E5);return Ob(b,a)}}function sc(a,b){return 0>=a.getFullYear()?b.ERAS[0]:b.ERAS[1]}function Rd(a){function b(a){var b;if(b=a.match(d)){a=new Date(0);var e=0,g=0,h=b[8]?a.setUTCFullYear:a.setFullYear,k=b[8]?a.setUTCHours:a.setHours;b[9]&&(e=Z(b[9]+b[10]),g=Z(b[9]+b[11]));h.call(a,Z(b[1]),Z(b[2])-1,Z(b[3]));e=Z(b[4]||0)-e;g=Z(b[5]||0)-g;h=Z(b[6]||0);b=Math.round(1E3*parseFloat("0."+(b[7]||
0)));k.call(a,e,g,h,b)}return a}var d=/^(\d{4})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/;return function(c,d,e){var g="",h=[],k,l;d=d||"mediumDate";d=a.DATETIME_FORMATS[d]||d;x(c)&&(c=Wg.test(c)?Z(c):b(c));ca(c)&&(c=new Date(c));if(!fa(c)||!isFinite(c.getTime()))return c;for(;d;)(l=Xg.exec(d))?(h=db(h,l,1),d=h.pop()):(h.push(d),d=null);var m=c.getTimezoneOffset();e&&(m=Gc(e,m),c=Wb(c,e,!0));q(h,function(b){k=Yg[b];g+=k?k(c,a.DATETIME_FORMATS,m):
"''"===b?"'":b.replace(/(^'|'$)/g,"").replace(/''/g,"'")});return g}}function Pg(){return function(a,b){z(b)&&(b=2);return fb(a,b)}}function Qg(){return function(a,b,d){b=Infinity===Math.abs(Number(b))?Number(b):Z(b);if(ja(b))return a;ca(a)&&(a=a.toString());if(!na(a))return a;d=!d||isNaN(d)?0:Z(d);d=0>d?Math.max(0,a.length+d):d;return 0<=b?tc(a,d,d+b):0===d?tc(a,b,a.length):tc(a,Math.max(0,d+b),d)}}function tc(a,b,d){return x(a)?a.slice(b,d):ya.call(a,b,d)}function Td(a){function b(b){return b.map(function(b){var c=
1,d=ab;if(A(b))d=b;else if(x(b)){if("+"===b.charAt(0)||"-"===b.charAt(0))c="-"===b.charAt(0)?-1:1,b=b.substring(1);if(""!==b&&(d=a(b),d.constant))var f=d(),d=function(a){return a[f]}}return{get:d,descending:c}})}function d(a){switch(typeof a){case "number":case "boolean":case "string":return!0;default:return!1}}function c(a,b){var c=0,d=a.type,k=b.type;if(d===k){var k=a.value,l=b.value;"string"===d?(k=k.toLowerCase(),l=l.toLowerCase()):"object"===d&&(G(k)&&(k=a.index),G(l)&&(l=b.index));k!==l&&(c=
k<l?-1:1)}else c=d<k?-1:1;return c}return function(a,e,g,h){if(null==a)return a;if(!na(a))throw P("orderBy")("notarray",a);E(e)||(e=[e]);0===e.length&&(e=["+"]);var k=b(e),l=g?-1:1,m=A(h)?h:c;a=Array.prototype.map.call(a,function(a,b){return{value:a,tieBreaker:{value:b,type:"number",index:b},predicateValues:k.map(function(c){var e=c.get(a);c=typeof e;if(null===e)c="string",e="null";else if("object"===c)a:{if(A(e.valueOf)&&(e=e.valueOf(),d(e)))break a;Dc(e)&&(e=e.toString(),d(e))}return{value:e,type:c,
index:b}})}});a.sort(function(a,b){for(var c=0,d=k.length;c<d;c++){var e=m(a.predicateValues[c],b.predicateValues[c]);if(e)return e*k[c].descending*l}return m(a.tieBreaker,b.tieBreaker)*l});return a=a.map(function(a){return a.value})}}function Wa(a){A(a)&&(a={link:a});a.restrict=a.restrict||"AC";return ia(a)}function Zd(a,b,d,c,f){var e=this,g=[];e.$error={};e.$$success={};e.$pending=void 0;e.$name=f(b.name||b.ngForm||"")(d);e.$dirty=!1;e.$pristine=!0;e.$valid=!0;e.$invalid=!1;e.$submitted=!1;e.$$parentForm=
Pb;e.$rollbackViewValue=function(){q(g,function(a){a.$rollbackViewValue()})};e.$commitViewValue=function(){q(g,function(a){a.$commitViewValue()})};e.$addControl=function(a){Sa(a.$name,"input");g.push(a);a.$name&&(e[a.$name]=a);a.$$parentForm=e};e.$$renameControl=function(a,b){var c=a.$name;e[c]===a&&delete e[c];e[b]=a;a.$name=b};e.$removeControl=function(a){a.$name&&e[a.$name]===a&&delete e[a.$name];q(e.$pending,function(b,c){e.$setValidity(c,null,a)});q(e.$error,function(b,c){e.$setValidity(c,null,
a)});q(e.$$success,function(b,c){e.$setValidity(c,null,a)});cb(g,a);a.$$parentForm=Pb};$d({ctrl:this,$element:a,set:function(a,b,c){var d=a[b];d?-1===d.indexOf(c)&&d.push(c):a[b]=[c]},unset:function(a,b,c){var d=a[b];d&&(cb(d,c),0===d.length&&delete a[b])},$animate:c});e.$setDirty=function(){c.removeClass(a,Xa);c.addClass(a,Qb);e.$dirty=!0;e.$pristine=!1;e.$$parentForm.$setDirty()};e.$setPristine=function(){c.setClass(a,Xa,Qb+" ng-submitted");e.$dirty=!1;e.$pristine=!0;e.$submitted=!1;q(g,function(a){a.$setPristine()})};
e.$setUntouched=function(){q(g,function(a){a.$setUntouched()})};e.$setSubmitted=function(){c.addClass(a,"ng-submitted");e.$submitted=!0;e.$$parentForm.$setSubmitted()}}function uc(a){a.$formatters.push(function(b){return a.$isEmpty(b)?b:b.toString()})}function Ya(a,b,d,c,f,e){var g=R(b[0].type);if(!f.android){var h=!1;b.on("compositionstart",function(){h=!0});b.on("compositionend",function(){h=!1;l()})}var k,l=function(a){k&&(e.defer.cancel(k),k=null);if(!h){var f=b.val();a=a&&a.type;"password"===
g||d.ngTrim&&"false"===d.ngTrim||(f=Y(f));(c.$viewValue!==f||""===f&&c.$$hasNativeValidators)&&c.$setViewValue(f,a)}};if(f.hasEvent("input"))b.on("input",l);else{var m=function(a,b,c){k||(k=e.defer(function(){k=null;b&&b.value===c||l(a)}))};b.on("keydown",function(a){var b=a.keyCode;91===b||15<b&&19>b||37<=b&&40>=b||m(a,this,this.value)});if(f.hasEvent("paste"))b.on("paste cut",m)}b.on("change",l);if(ae[g]&&c.$$hasNativeValidators&&g===d.type)b.on("keydown wheel mousedown",function(a){if(!k){var b=
this.validity,c=b.badInput,d=b.typeMismatch;k=e.defer(function(){k=null;b.badInput===c&&b.typeMismatch===d||l(a)})}});c.$render=function(){var a=c.$isEmpty(c.$viewValue)?"":c.$viewValue;b.val()!==a&&b.val(a)}}function Rb(a,b){return function(d,c){var f,e;if(fa(d))return d;if(x(d)){'"'===d.charAt(0)&&'"'===d.charAt(d.length-1)&&(d=d.substring(1,d.length-1));if(Zg.test(d))return new Date(d);a.lastIndex=0;if(f=a.exec(d))return f.shift(),e=c?{yyyy:c.getFullYear(),MM:c.getMonth()+1,dd:c.getDate(),HH:c.getHours(),
mm:c.getMinutes(),ss:c.getSeconds(),sss:c.getMilliseconds()/1E3}:{yyyy:1970,MM:1,dd:1,HH:0,mm:0,ss:0,sss:0},q(f,function(a,c){c<b.length&&(e[b[c]]=+a)}),new Date(e.yyyy,e.MM-1,e.dd,e.HH,e.mm,e.ss||0,1E3*e.sss||0)}return NaN}}function qb(a,b,d,c){return function(f,e,g,h,k,l,m){function n(a){return a&&!(a.getTime&&a.getTime()!==a.getTime())}function r(a){return w(a)&&!fa(a)?d(a)||void 0:a}vc(f,e,g,h);Ya(f,e,g,h,k,l);var s=h&&h.$options&&h.$options.timezone,q;h.$$parserName=a;h.$parsers.push(function(a){if(h.$isEmpty(a))return null;
if(b.test(a))return a=d(a,q),s&&(a=Wb(a,s)),a});h.$formatters.push(function(a){if(a&&!fa(a))throw rb("datefmt",a);if(n(a))return(q=a)&&s&&(q=Wb(q,s,!0)),m("date")(a,c,s);q=null;return""});if(w(g.min)||g.ngMin){var t;h.$validators.min=function(a){return!n(a)||z(t)||d(a)>=t};g.$observe("min",function(a){t=r(a);h.$validate()})}if(w(g.max)||g.ngMax){var p;h.$validators.max=function(a){return!n(a)||z(p)||d(a)<=p};g.$observe("max",function(a){p=r(a);h.$validate()})}}}function vc(a,b,d,c){(c.$$hasNativeValidators=
G(b[0].validity))&&c.$parsers.push(function(a){var c=b.prop("validity")||{};return c.badInput||c.typeMismatch?void 0:a})}function be(a){a.$$parserName="number";a.$parsers.push(function(b){if(a.$isEmpty(b))return null;if($g.test(b))return parseFloat(b)});a.$formatters.push(function(b){if(!a.$isEmpty(b)){if(!ca(b))throw rb("numfmt",b);b=b.toString()}return b})}function sb(a){w(a)&&!ca(a)&&(a=parseFloat(a));return ja(a)?void 0:a}function wc(a){var b=a.toString(),d=b.indexOf(".");return-1===d?-1<a&&1>
a&&(a=/e-(\d+)$/.exec(b))?Number(a[1]):0:b.length-d-1}function ce(a,b,d,c,f){if(w(c)){a=a(c);if(!a.constant)throw rb("constexpr",d,c);return a(b)}return f}function xc(a,b){a="ngClass"+a;return["$animate",function(d){function c(a,b){var c=[],d=0;a:for(;d<a.length;d++){for(var f=a[d],m=0;m<b.length;m++)if(f===b[m])continue a;c.push(f)}return c}function f(a){var b=[];return E(a)?(q(a,function(a){b=b.concat(f(a))}),b):x(a)?a.split(" "):G(a)?(q(a,function(a,c){a&&(b=b.concat(c.split(" ")))}),b):a}return{restrict:"AC",
link:function(e,g,h){function k(a){a=l(a,1);h.$addClass(a)}function l(a,b){var c=g.data("$classCounts")||W(),d=[];q(a,function(a){if(0<b||c[a])c[a]=(c[a]||0)+b,c[a]===+(0<b)&&d.push(a)});g.data("$classCounts",c);return d.join(" ")}function m(a,b){var e=c(b,a),f=c(a,b),e=l(e,1),f=l(f,-1);e&&e.length&&d.addClass(g,e);f&&f.length&&d.removeClass(g,f)}function n(a){if(!0===b||(e.$index&1)===b){var c=f(a||[]);if(!r)k(c);else if(!pa(a,r)){var d=f(r);m(d,c)}}r=E(a)?a.map(function(a){return ma(a)}):ma(a)}
var r;h.$observe("class",function(b){n(e.$eval(h[a]))});"ngClass"!==a&&e.$watch("$index",function(a,c){var d=a&1;if(d!==(c&1)){var e=f(r);d===b?k(e):(d=l(e,-1),h.$removeClass(d))}});e.$watch(h[a],n,!0)}}}]}function $d(a){function b(a,b){b&&!e[a]?(k.addClass(f,a),e[a]=!0):!b&&e[a]&&(k.removeClass(f,a),e[a]=!1)}function d(a,c){a=a?"-"+Kc(a,"-"):"";b(tb+a,!0===c);b(de+a,!1===c)}var c=a.ctrl,f=a.$element,e={},g=a.set,h=a.unset,k=a.$animate;e[de]=!(e[tb]=f.hasClass(tb));c.$setValidity=function(a,e,f){z(e)?
(c.$pending||(c.$pending={}),g(c.$pending,a,f)):(c.$pending&&h(c.$pending,a,f),ee(c.$pending)&&(c.$pending=void 0));La(e)?e?(h(c.$error,a,f),g(c.$$success,a,f)):(g(c.$error,a,f),h(c.$$success,a,f)):(h(c.$error,a,f),h(c.$$success,a,f));c.$pending?(b(fe,!0),c.$valid=c.$invalid=void 0,d("",null)):(b(fe,!1),c.$valid=ee(c.$error),c.$invalid=!c.$valid,d("",c.$valid));e=c.$pending&&c.$pending[a]?void 0:c.$error[a]?!1:c.$$success[a]?!0:null;d(a,e);c.$$parentForm.$setValidity(a,e,c)}}function ee(a){if(a)for(var b in a)if(a.hasOwnProperty(b))return!1;
return!0}var ah=/^\/(.+)\/([a-z]*)$/,xa=Object.prototype.hasOwnProperty,R=function(a){return x(a)?a.toLowerCase():a},yb=function(a){return x(a)?a.toUpperCase():a},Ca,B,Ba,ya=[].slice,vg=[].splice,bh=[].push,oa=Object.prototype.toString,Ec=Object.getPrototypeOf,za=P("ng"),$=v.angular||(v.angular={}),Yb,ub=0;Ca=v.document.documentMode;var ja=Number.isNaN||function(a){return a!==a};C.$inject=[];ab.$inject=[];var E=Array.isArray,se=/^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array]$/,
Y=function(a){return x(a)?a.trim():a},Md=function(a){return a.replace(/([-()[\]{}+?*.$^|,:#<!\\])/g,"\\$1").replace(/\x08/g,"\\x08")},aa=function(){if(!w(aa.rules)){var a=v.document.querySelector("[ng-csp]")||v.document.querySelector("[data-ng-csp]");if(a){var b=a.getAttribute("ng-csp")||a.getAttribute("data-ng-csp");aa.rules={noUnsafeEval:!b||-1!==b.indexOf("no-unsafe-eval"),noInlineStyle:!b||-1!==b.indexOf("no-inline-style")}}else{a=aa;try{new Function(""),b=!1}catch(d){b=!0}a.rules={noUnsafeEval:b,
noInlineStyle:!1}}}return aa.rules},wb=function(){if(w(wb.name_))return wb.name_;var a,b,d=Pa.length,c,f;for(b=0;b<d;++b)if(c=Pa[b],a=v.document.querySelector("["+c.replace(":","\\:")+"jq]")){f=a.getAttribute(c+"jq");break}return wb.name_=f},ve=/:/g,Pa=["ng-","data-ng-","ng:","x-ng-"],ye=function(a){var b=a.currentScript;if(!b)return!0;if(!(b instanceof v.HTMLScriptElement||b instanceof v.SVGScriptElement))return!1;b=b.attributes;return[b.getNamedItem("src"),b.getNamedItem("href"),b.getNamedItem("xlink:href")].every(function(b){if(!b)return!0;
if(!b.value)return!1;var c=a.createElement("a");c.href=b.value;if(a.location.origin===c.origin)return!0;switch(c.protocol){case "http:":case "https:":case "ftp:":case "blob:":case "file:":case "data:":return!0;default:return!1}})}(v.document),Be=/[A-Z]/g,Lc=!1,Ee=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)(?:[^\w:>-][^>]*)?)\/>/gi,Ma=3,He={vendor:"XLTS.dev",full:"1.5.16",major:1,minor:5,dot:16,codeName:"exploitatively-ceasing"};U.expando="ng339";var lb=U.cache={},ig=1;U._data=function(a){return this.cache[a[this.expando]]||
{}};var eg=/([:\-_]+(.))/g,fg=/^moz([A-Z])/,Cb={mouseleave:"mouseout",mouseenter:"mouseover"},$b=P("jqLite"),hg=/^<([\w-]+)\s*\/?>(?:<\/\1>|)$/,Zb=/<|&#?\w+;/,gg=/<([\w:-]+)/,ka={thead:["table"],col:["colgroup","table"],tr:["tbody","table"],td:["tr","tbody","table"]};ka.tbody=ka.tfoot=ka.colgroup=ka.caption=ka.thead;ka.th=ka.td;var jb={option:[1,'<select multiple="multiple">',"</select>"],_default:[0,"",""]},yc;for(yc in ka){var ge=ka[yc],he=ge.slice().reverse();jb[yc]=[he.length,"<"+he.join("><")+
">","</"+ge.join("></")+">"]}jb.optgroup=jb.option;var ng=v.Node.prototype.contains||function(a){return!!(this.compareDocumentPosition(a)&16)},Qa=U.prototype={ready:function(a){function b(){d||(d=!0,a())}var d=!1;"complete"===v.document.readyState?v.setTimeout(b):(this.on("DOMContentLoaded",b),U(v).on("load",b))},toString:function(){var a=[];q(this,function(b){a.push(""+b)});return"["+a.join(", ")+"]"},eq:function(a){return 0<=a?B(this[a]):B(this[this.length+a])},length:0,push:bh,sort:[].sort,splice:[].splice},
Ib={};q("multiple selected checked disabled readOnly required open".split(" "),function(a){Ib[R(a)]=a});var cd={};q("input select option textarea button form details".split(" "),function(a){cd[a]=!0});var jd={ngMinlength:"minlength",ngMaxlength:"maxlength",ngMin:"min",ngMax:"max",ngPattern:"pattern"};q({data:bc,removeData:kb,hasData:function(a){for(var b in lb[a.ng339])return!0;return!1},cleanData:function(a){for(var b=0,d=a.length;b<d;b++)kb(a[b])},htmlPrefilter:function(a){return a}},function(a,
b){U[b]=a});q({data:bc,inheritedData:Gb,scope:function(a){return B.data(a,"$scope")||Gb(a.parentNode||a,["$isolateScope","$scope"])},isolateScope:function(a){return B.data(a,"$isolateScope")||B.data(a,"$isolateScopeNoTemplate")},controller:$c,injector:function(a){return Gb(a,"$injector")},removeAttr:function(a,b){a.removeAttribute(b)},hasClass:Db,css:function(a,b,d){b=ib(b);if(w(d))a.style[b]=d;else return a.style[b]},attr:function(a,b,d){var c=a.nodeType;if(c!==Ma&&2!==c&&8!==c)if(c=R(b),Ib[c])if(w(d))d?
(a[b]=!0,a.setAttribute(b,c)):(a[b]=!1,a.removeAttribute(c));else return a[b]||(a.attributes.getNamedItem(b)||C).specified?c:void 0;else if(w(d))a.setAttribute(b,d);else if(a.getAttribute)return a=a.getAttribute(b,2),null===a?void 0:a},prop:function(a,b,d){if(w(d))a[b]=d;else return a[b]},text:function(){function a(a,d){if(z(d)){var c=a.nodeType;return 1===c||c===Ma?a.textContent:""}a.textContent=d}a.$dv="";return a}(),val:function(a,b){if(z(b)){if(a.multiple&&"select"===va(a)){var d=[];q(a.options,
function(a){a.selected&&d.push(a.value||a.text)});return 0===d.length?null:d}return a.value}a.value=b},html:function(a,b){if(z(b))return a.innerHTML;Ab(a,!0);a.innerHTML=b},empty:ad},function(a,b){U.prototype[b]=function(b,c){var f,e,g=this.length;if(a!==ad&&z(2===a.length&&a!==Db&&a!==$c?b:c)){if(G(b)){for(f=0;f<g;f++)if(a===bc)a(this[f],b);else for(e in b)a(this[f],e,b[e]);return this}f=a.$dv;g=z(f)?Math.min(g,1):g;for(e=0;e<g;e++){var h=a(this[e],b,c);f=f?f+h:h}return f}for(f=0;f<g;f++)a(this[f],
b,c);return this}});q({removeData:kb,on:function(a,b,d,c){if(w(c))throw $b("onargs");if(Vc(a)){c=Bb(a,!0);var f=c.events,e=c.handle;e||(e=c.handle=kg(a,f));c=0<=b.indexOf(" ")?b.split(" "):[b];for(var g=c.length,h=function(b,c,g){var h=f[b];h||(h=f[b]=[],h.specialHandlerWrapper=c,"$destroy"===b||g||a.addEventListener(b,e,!1));h.push(d)};g--;)b=c[g],Cb[b]?(h(Cb[b],mg),h(b,void 0,!0)):h(b)}},off:Zc,one:function(a,b,d){a=B(a);a.on(b,function f(){a.off(b,d);a.off(b,f)});a.on(b,d)},replaceWith:function(a,
b){var d,c=a.parentNode;Ab(a);q(new U(b),function(b){d?c.insertBefore(b,d.nextSibling):c.replaceChild(b,a);d=b})},children:function(a){var b=[];q(a.childNodes,function(a){1===a.nodeType&&b.push(a)});return b},contents:function(a){return a.contentDocument||a.childNodes||[]},append:function(a,b){var d=a.nodeType;if(1===d||11===d){b=new U(b);for(var d=0,c=b.length;d<c;d++)a.appendChild(b[d])}},prepend:function(a,b){if(1===a.nodeType){var d=a.firstChild;q(new U(b),function(b){a.insertBefore(b,d)})}},
wrap:function(a,b){Xc(a,B(b).eq(0).clone()[0])},remove:Hb,detach:function(a){Hb(a,!0)},after:function(a,b){var d=a,c=a.parentNode;if(c){b=new U(b);for(var f=0,e=b.length;f<e;f++){var g=b[f];c.insertBefore(g,d.nextSibling);d=g}}},addClass:Fb,removeClass:Eb,toggleClass:function(a,b,d){b&&q(b.split(" "),function(b){var f=d;z(f)&&(f=!Db(a,b));(f?Fb:Eb)(a,b)})},parent:function(a){return(a=a.parentNode)&&11!==a.nodeType?a:null},next:function(a){return a.nextElementSibling},find:function(a,b){return a.getElementsByTagName?
a.getElementsByTagName(b):[]},clone:ac,triggerHandler:function(a,b,d){var c,f,e=b.type||b,g=Bb(a);if(g=(g=g&&g.events)&&g[e])c={preventDefault:function(){this.defaultPrevented=!0},isDefaultPrevented:function(){return!0===this.defaultPrevented},stopImmediatePropagation:function(){this.immediatePropagationStopped=!0},isImmediatePropagationStopped:function(){return!0===this.immediatePropagationStopped},stopPropagation:C,type:e,target:a},b.type&&(c=T(c,b)),b=ma(g),f=d?[c].concat(d):[c],q(b,function(b){c.isImmediatePropagationStopped()||
b.apply(a,f)})}},function(a,b){U.prototype[b]=function(b,c,f){for(var e,g=0,h=this.length;g<h;g++)z(e)?(e=a(this[g],b,c,f),w(e)&&(e=B(e))):Yc(e,a(this[g],b,c,f));return w(e)?e:this}});U.prototype.bind=U.prototype.on;U.prototype.unbind=U.prototype.off;Ta.prototype={put:function(a,b){this[Da(a,this.nextUid)]=b},get:function(a){return this[Da(a,this.nextUid)]},remove:function(a){var b=this[a=Da(a,this.nextUid)];delete this[a];return b}};var cg=[function(){this.$get=[function(){return Ta}]}],pg=/^([^(]+?)=>/,
qg=/^[^(]*\(\s*([^)]*)\)/m,ch=/,/,dh=/^\s*(_?)(\S+?)\1\s*$/,og=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg,Ea=P("$injector");gb.$$annotate=function(a,b,d){var c;if("function"===typeof a){if(!(c=a.$inject)){c=[];if(a.length){if(b)throw x(d)&&d||(d=a.name||rg(a)),Ea("strictdi",d);b=dd(a);q(b[1].split(ch),function(a){a.replace(dh,function(a,b,d){c.push(d)})})}a.$inject=c}}else E(a)?(b=a.length-1,Ra(a[b],"fn"),c=a.slice(0,b)):Ra(a,"fn",!0);return c};var ie=P("$animate"),vf=function(){this.$get=C},wf=function(){var a=
new Ta,b=[];this.$get=["$$AnimateRunner","$rootScope",function(d,c){function f(a,b,c){var d=!1;b&&(b=x(b)?b.split(" "):E(b)?b:[],q(b,function(b){b&&(d=!0,a[b]=c)}));return d}function e(){q(b,function(b){var c=a.get(b);if(c){var d=sg(b.attr("class")),e="",f="";q(c,function(a,b){a!==!!d[b]&&(a?e+=(e.length?" ":"")+b:f+=(f.length?" ":"")+b)});q(b,function(a){e&&Fb(a,e);f&&Eb(a,f)});a.remove(b)}});b.length=0}return{enabled:C,on:C,off:C,pin:C,push:function(g,h,k,l){l&&l();k=k||{};k.from&&g.css(k.from);
...
(this.$$classNameFilter=a instanceof RegExp?a:null)&&/(\s+|\/)ng-animate(\s+|\/)/.test(this.$$classNameFilter.toString()))throw ie("nongcls","ng-animate");return this.$$classNameFilter};this.$get=["$$animateQueue",function(a){function b(a,c,d){if(d){var h;a:{for(h=0;h<d.length;h++){var k=d[h];if(1===k.nodeType){h=k;break a}}h=void 0}!h||h.parentNode||h.previousElementSibling||(d=null)}d?d.after(a):c.prepend(a)}return{on:a.on,off:a.off,pin:a.pin,enabled:a.enabled,cancel:function(a){a.end&&a.end()},
enter:function(f,e,g,h){e=e&&B(e);g=g&&B(g);e=e||g.parent();b(f,e,g);return a.push(f,"enter",Fa(h))},move:function(f,e,g,h){e=e&&B(e);g=g&&B(g);e=e||g.parent();b(f,e,g);return a.push(f,"move",Fa(h))},leave:function(b,c){return a.push(b,"leave",Fa(c),function(){b.remove()})},addClass:function(b,c,g){g=Fa(g);g.addClass=mb(g.addclass,c);return a.push(b,"addClass",g)},removeClass:function(b,c,g){g=Fa(g);g.removeClass=mb(g.removeClass,c);return a.push(b,"removeClass",g)},setClass:function(b,c,g,h){h=Fa(h);
...
["$q","$sniffer","$$animateAsyncRun","$document","$timeout",function(a,b,d,c,f){function e(a){this.setHost(a);var b=d();this._doneCallbacks=[];this._tick=function(a){var d=c[0];d&&d.hidden?f(a,0,!1):b(a)};this._state=0}e.chain=function(a,b){function c(){if(d===a.length)b(!0);else a[d](function(a){!1===a?b(!1):(d++,c())})}var d=0;c()};e.all=function(a,b){function c(f){e=e&&f;++d===a.length&&b(e)}var d=0,e=!0;q(a,function(a){a.done(c)})};e.prototype={setHost:function(a){this.host=a||{}},done:function(a){2===
...
null);g.removeClass&&(b.removeClass(g.removeClass),g.removeClass=null);g.to&&(b.css(g.to),g.to=null);h||k.complete();h=!0});return k}var g=f||{};g.$$prepared||(g=ta(g));g.cleanupStyles&&(g.from=g.to=null);g.from&&(b.css(g.from),g.from=null);var h,k=new d;return{start:e,end:e}}}]},ha=P("$compile"),fc=new function(){};Nc.$inject=["$provide","$$sanitizeUriProvider"];Jb.prototype.isFirstChange=function(){return this.previousValue===fc};var ed=/^((?:x|data)[:\-_])/i,ld=P("$controller"),kd=/^(\S+)(\s+as\s+([\w$]+))?$/,
Ef=function(){this.$get=["$document",function(a){return function(b){b?!b.nodeType&&b instanceof B&&(b=b[0]):b=a[0].body;return b.offsetWidth+1}}]},md="application/json",ic={"Content-Type":md+";charset=utf-8"},xg=/^\[|^\{(?!\{)/,yg={"[":/]$/,"{":/}$/},wg=/^\)]\}',?\n/,jc=P("$http"),qd=function(a){return function(){throw jc("legacy",a);}},Ka=$.$interpolateMinErr=P("$interpolate");Ka.throwNoconcat=function(a){throw Ka("noconcat",a);};Ka.interr=function(a,b){return Ka("interr",a,b.toString())};var Mf=
function(){this.$get=["$window",function(a){function b(a){var b=function(a){b.data=a;b.called=!0};b.id=a;return b}var d=a.angular.callbacks,c={};return{createCallback:function(a){a="_"+(d.$$counter++).toString(36);var e="angular.callbacks."+a,g=b(a);c[e]=d[a]=g;return e},wasCalled:function(a){return c[a].called},getResponse:function(a){return c[a].data},removeCallback:function(a){delete d[c[a].id];delete c[a]}}}]},eh=/^([^?#]*)(\?([^#]*))?(#(.*))?$/,Ag={http:80,https:443,ftp:21},nb=P("$location"),
Bg=/^\s*[\\/]{2,}/,fh={$$absUrl:"",$$html5:!1,$$replace:!1,absUrl:Kb("$$absUrl"),url:function(a){if(z(a))return this.$$url;var b=eh.exec(a);(b[1]||""===a)&&this.path(decodeURIComponent(b[1]));(b[2]||b[1]||""===a)&&this.search(b[3]||"");this.hash(b[5]||"");return this},protocol:Kb("$$protocol"),host:Kb("$$host"),port:Kb("$$port"),path:vd("$$path",function(a){a=null!==a?a.toString():"";return"/"===a.charAt(0)?a:"/"+a}),search:function(a,b){switch(arguments.length){case 0:return this.$$search;case 1:if(x(a)||
ca(a))a=a.toString(),this.$$search=Ic(a);else if(G(a))a=ta(a,{}),q(a,function(b,c){null==b&&delete a[c]}),this.$$search=a;else throw nb("isrcharg");break;default:z(b)||null===b?delete this.$$search[a]:this.$$search[a]=b}this.$$compose();return this},hash:vd("$$hash",function(a){return null!==a?a.toString():""}),replace:function(){this.$$replace=!0;return this}};q([ud,mc,lc],function(a){a.prototype=Object.create(fh);a.prototype.state=function(b){if(!arguments.length)return this.$$state;if(a!==lc||
!this.$$html5)throw nb("nostate");this.$$state=z(b)?null:b;return this}});var ea=P("$parse"),xd=[].constructor,yd=(!1).constructor,zd=Function.constructor,Ad=(0).constructor,Bd={}.constructor,Cd="".constructor,Gg=xd.prototype,Hg=yd.prototype,Mb=zd.prototype,Ig=Ad.prototype,Dd=Bd.prototype,Jg=Cd.prototype,Dg=Mb.call,Eg=Mb.apply,Fg=Mb.bind,Lg=Dd.valueOf,Sb=W();q("+ - * / % === !== == != < > <= >= && || ! = |".split(" "),function(a){Sb[a]=!0});var gh={n:"\n",f:"\f",r:"\r",t:"\t",v:"\v","'":"'",'"':'"'},
...
a+",text)"},lazyRecurse:function(a,b,d,c,f,e){var g=this;return function(){g.recurse(a,b,d,c,f,e)}},lazyAssign:function(a,b){var d=this;return function(){d.assign(a,b)}},stringEscapeRegex:/[^ a-zA-Z0-9]/g,stringEscapeFn:function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)},escape:function(a){if(x(a))return"'"+a.replace(this.stringEscapeRegex,this.stringEscapeFn)+"'";if(ca(a))return a.toString();if(!0===a)return"true";if(!1===a)return"false";if(null===a)return"null";if("undefined"===
...
a)})}}}});q(["src","srcset","href"],function(a){var b=Ga("ng-"+a);zb[b]=function(){return{priority:99,link:function(d,c,f){var e=a,g=a;"href"===a&&"[object SVGAnimatedString]"===oa.call(c.prop("href"))&&(g="xlinkHref",f.$attr[g]="xlink:href",e=null);f.$observe(b,function(b){b?(f.$set(g,b),Ca&&e&&c.prop(e,f[g])):"href"===a&&f.$set(g,null)})}}}});var Pb={$addControl:C,$$renameControl:function(a,b){a.$name=b},$removeControl:C,$setValidity:C,$setDirty:C,$setPristine:C,$setSubmitted:C};Zd.$inject=["$element",
"$attrs","$scope","$animate","$interpolate"];var je=function(a){return["$timeout","$parse",function(b,d){function c(a){return""===a?d('this[""]').assign:d(a).assign||C}return{name:"form",restrict:a?"EAC":"E",require:["form","^^?form"],controller:Zd,compile:function(d,e){d.addClass(Xa).addClass(tb);var g=e.name?"name":a&&e.ngForm?"ngForm":!1;return{pre:function(a,d,e,f){var n=f[0];if(!("action"in e)){var r=function(b){a.$apply(function(){n.$commitViewValue();n.$setSubmitted()});b.preventDefault()};
d[0].addEventListener("submit",r,!1);d.on("$destroy",function(){b(function(){d[0].removeEventListener("submit",r,!1)},0,!1)})}(f[1]||n.$$parentForm).$addControl(n);var q=g?c(n.$name):C;g&&(q(a,n),e.$observe(g,function(b){n.$name!==b&&(q(a,void 0),n.$$parentForm.$$renameControl(n,b),q=c(n.$name),q(a,n))}));d.on("$destroy",function(){n.$$parentForm.$removeControl(n);q(a,void 0);T(n,Pb)})}}}}}]},Ke=je(),We=je(!0),Zg=/^\d{4,}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+(?:[+-][0-2]\d:[0-5]\d|Z)$/,hh=/^[a-z][a-z\d.+-]*:\/*(?:[^:@]+(?::[^@]+)?@)?(?:[^\s:/?#]+|\[[a-f\d:]+])(?::\d+)?(?:\/[^?#]*)?(?:\?[^#]*)?(?:#.*)?$/i,
...
!0});var oe={text:function(a,b,d,c,f,e){Ya(a,b,d,c,f,e);uc(c)},date:qb("date",ke,Rb(ke,["yyyy","MM","dd"]),"yyyy-MM-dd"),"datetime-local":qb("datetimelocal",le,Rb(le,"yyyy MM dd HH mm ss sss".split(" ")),"yyyy-MM-ddTHH:mm:ss.sss"),time:qb("time",ne,Rb(ne,["HH","mm","ss","sss"]),"HH:mm:ss.sss"),week:qb("week",zc,function(a,b){if(fa(a))return a;if(x(a)){zc.lastIndex=0;var d=zc.exec(a);if(d){var c=+d[1],f=+d[2],e=d=0,g=0,h=0,k=Xd(c),f=7*(f-1);b&&(d=b.getHours(),e=b.getMinutes(),g=b.getSeconds(),h=b.getMilliseconds());
...
b,d,c,f,e){function g(a,c){b.attr(a,d[a]);d.$observe(a,c)}function h(a){n=sb(a);ja(c.$modelValue)||(m?(a=b.val(),n>a&&(a=n,b.val(a)),c.$setViewValue(a)):c.$validate())}function k(a){r=sb(a);ja(c.$modelValue)||(m?(a=b.val(),r<a&&(b.val(r),a=r<n?n:r),c.$setViewValue(a)):c.$validate())}function l(a){q=sb(a);ja(c.$modelValue)||(m&&c.$viewValue!==b.val()?c.$setViewValue(b.val()):c.$validate())}vc(a,b,d,c);be(c);Ya(a,b,d,c,f,e);var m=c.$$hasNativeValidators&&"range"===b[0].type,n=m?0:void 0,r=m?100:void 0,
q=m?1:void 0,t=b[0].validity;a=w(d.min);f=w(d.max);e=w(d.step);var I=c.$render;c.$render=m&&w(t.rangeUnderflow)&&w(t.rangeOverflow)?function(){I();c.$setViewValue(b.val())}:I;a&&(c.$validators.min=m?function(){return!0}:function(a,b){return c.$isEmpty(b)||z(n)||b>=n},g("min",h));f&&(c.$validators.max=m?function(){return!0}:function(a,b){return c.$isEmpty(b)||z(r)||b<=r},g("max",k));e&&(c.$validators.step=m?function(){return!t.stepMismatch}:function(a,b){var d;if(!(d=c.$isEmpty(b)||z(q))){d=n||0;var e=
q,f=Number(b);if((f|0)!==f||(d|0)!==d||(e|0)!==e){var g=Math.max(wc(f),wc(d),wc(e)),g=Math.pow(10,g),f=f*g;d*=g;e*=g}d=0===(f-d)%e}return d},g("step",l))},checkbox:function(a,b,d,c,f,e,g,h){var k=ce(h,a,"ngTrueValue",d.ngTrueValue,!0),l=ce(h,a,"ngFalseValue",d.ngFalseValue,!1);b.on("click",function(a){c.$setViewValue(b[0].checked,a&&a.type)});c.$render=function(){b[0].checked=c.$viewValue};c.$isEmpty=function(a){return!1===a};c.$formatters.push(function(a){return pa(a,k)});c.$parsers.push(function(a){return a?
k:l})},hidden:C,button:C,submit:C,reset:C,file:C},Oc=["$browser","$sniffer","$filter","$parse",function(a,b,d,c){return{restrict:"E",require:["?ngModel"],link:{pre:function(f,e,g,h){if(h[0]){var k=R(g.type);"range"!==k||g.hasOwnProperty("ngInputRange")||(k="text");(oe[k]||oe.text)(f,e,g,h[0],b,a,d,c)}}}}}],rf=function(){var a={configurable:!0,enumerable:!1,get:function(){return this.getAttribute("value")||""},set:function(a){this.setAttribute("value",a)}};return{restrict:"E",priority:200,compile:function(b,
...
terminal:!0,transclude:"element",controller:$.noop,compile:function(c,f){var e=f.ngInclude||f.src,g=f.onload||"",h=f.autoscroll;return function(c,f,m,n,r){var q=0,t,I,p,v=function(){I&&(I.remove(),I=null);t&&(t.$destroy(),t=null);p&&(d.leave(p).done(function(a){!1!==a&&(I=null)}),I=p,p=null)};c.$watch(e,function(e){var m=function(a){!1===a||!w(h)||h&&!c.$eval(h)||b()},M=++q;e?(a(e,!0).then(function(a){if(!c.$$destroyed&&M===q){var b=c.$new();n.template=a;a=r(b,function(a){v();d.enter(a,null,f).done(m)});
t=b;p=a;t.$emit("$includeContentLoaded",e);c.$eval(g)}},function(){c.$$destroyed||M!==q||(v(),c.$emit("$includeContentError",e))}),c.$emit("$includeContentRequested",e)):(v(),n.template=null)})}}}}],qf=["$compile",function(a){return{restrict:"ECA",priority:-400,require:"ngInclude",link:function(b,d,c,f){oa.call(d[0]).match(/SVG/)?(d.empty(),a(Wc(f.template,v.document).childNodes)(b,function(a){d.append(a)},{futureParentElement:d})):(d.html(f.template),a(d.contents())(b))}}}],$e=Wa({priority:450,compile:function(){return{pre:function(a,
b,d){a.$eval(d.ngInit)}}}}),mf=function(){return{restrict:"A",priority:100,require:"ngModel",link:function(a,b,d,c){var f=b.attr(d.$attr.ngList)||", ",e="false"!==d.ngTrim,g=e?Y(f):f;c.$parsers.push(function(a){if(!z(a)){var b=[];a&&q(a.split(g),function(a){a&&b.push(e?Y(a):a)});return b}});c.$formatters.push(function(a){if(E(a))return a.join(f)});c.$isEmpty=function(a){return!a||!a.length}}}},tb="ng-valid",de="ng-invalid",Xa="ng-pristine",Qb="ng-dirty",fe="ng-pending",rb=P("ngModel"),lh=["$scope",
...
this.$$parentForm=Pb;var m=f(d.ngModel),n=m.assign,r=m,s=n,t=null,I,p=this;this.$$setOptions=function(a){if((p.$options=a)&&a.getterSetter){var b=f(d.ngModel+"()"),e=f(d.ngModel+"($$$p)");r=function(a){var c=m(a);A(c)&&(c=b(a));return c};s=function(a,b){A(m(a))?e(a,{$$$p:b}):n(a,b)}}else if(!m.assign)throw rb("nonassign",d.ngModel,Aa(c));};this.$render=C;this.$isEmpty=function(a){return z(a)||""===a||null===a||a!==a};this.$$updateEmptyClasses=function(a){p.$isEmpty(a)?(e.removeClass(c,"ng-not-empty"),
e.addClass(c,"ng-empty")):(e.removeClass(c,"ng-empty"),e.addClass(c,"ng-not-empty"))};var v=0;$d({ctrl:this,$element:c,set:function(a,b){a[b]=!0},unset:function(a,b){delete a[b]},$animate:e});this.$setPristine=function(){p.$dirty=!1;p.$pristine=!0;e.removeClass(c,Qb);e.addClass(c,Xa)};this.$setDirty=function(){p.$dirty=!0;p.$pristine=!1;e.removeClass(c,Xa);e.addClass(c,Qb);p.$$parentForm.$setDirty()};this.$setUntouched=function(){p.$touched=!1;p.$untouched=!0;e.setClass(c,"ng-untouched","ng-touched")};
...
function(a,b,c){function d(){var c=!0;q(p.$validators,function(d,e){var g=d(a,b);c=c&&g;f(e,g)});return c?!0:(q(p.$asyncValidators,function(a,b){f(b,null)}),!1)}function e(){var c=[],d=!0;q(p.$asyncValidators,function(e,g){var h=e(a,b);if(!h||!A(h.then))throw rb("nopromise",h);f(g,void 0);c.push(h.then(function(){f(g,!0)},function(){d=!1;f(g,!1)}))});c.length?k.all(c).then(function(){g(d)},C):g(!0)}function f(a,b){h===v&&p.$setValidity(a,b)}function g(a){h===v&&c(a)}v++;var h=v;(function(){var a=
p.$$parserName||"parse";if(z(I))f(a,null);else return I||(q(p.$validators,function(a,b){f(b,null)}),q(p.$asyncValidators,function(a,b){f(b,null)})),f(a,I),I;return!0})()?d()?e():g(!1):g(!1)};this.$commitViewValue=function(){var a=p.$viewValue;g.cancel(t);if(p.$$lastCommittedViewValue!==a||""===a&&p.$$hasNativeValidators)p.$$updateEmptyClasses(a),p.$$lastCommittedViewValue=a,p.$pristine&&this.$setDirty(),this.$$parseAndValidate()};this.$$parseAndValidate=function(){var b=p.$$lastCommittedViewValue;
if(I=z(b)?void 0:!0)for(var c=0;c<p.$parsers.length;c++)if(b=p.$parsers[c](b),z(b)){I=!1;break}ja(p.$modelValue)&&(p.$modelValue=r(a));var d=p.$modelValue,e=p.$options&&p.$options.allowInvalid;p.$$rawModelValue=b;e&&(p.$modelValue=b,p.$modelValue!==d&&p.$$writeModelToScope());p.$$runValidators(b,p.$$lastCommittedViewValue,function(a){e||(p.$modelValue=a?b:void 0,p.$modelValue!==d&&p.$$writeModelToScope())})};this.$$writeModelToScope=function(){s(a,p.$modelValue);q(p.$viewChangeListeners,function(a){try{a()}catch(c){b(c)}})};
...
p.$$rawModelValue=b;I=void 0;for(var c=p.$formatters,d=c.length,e=b;d--;)e=c[d](e);p.$viewValue!==e&&(p.$$updateEmptyClasses(e),p.$viewValue=p.$$lastCommittedViewValue=e,p.$render(),p.$$runValidators(p.$modelValue,p.$viewValue,C))}return b})}],lf=["$rootScope",function(a){return{restrict:"A",require:["ngModel","^?form","^?ngModelOptions"],controller:lh,priority:1,compile:function(b){b.addClass(Xa).addClass("ng-untouched").addClass(tb);return{pre:function(a,b,f,e){var g=e[0];b=e[1]||g.$$parentForm;
...
jf=["$compile","$document","$parse",function(a,b,d){function c(a,b,c){function e(a,b,c,d,f){this.selectValue=a;this.viewValue=b;this.label=c;this.group=d;this.disabled=f}function f(a){var b;if(!s&&na(a))b=a;else{b=[];for(var c in a)a.hasOwnProperty(c)&&"$"!==c.charAt(0)&&b.push(c)}return b}var n=a.match(oh);if(!n)throw nh("iexp",a,Aa(b));var q=n[5]||n[7],s=n[6];a=/ as /.test(n[0])&&n[1];var t=n[9];b=d(n[2]?n[1]:q);var v=a&&d(a)||b,p=t&&d(t),w=t?function(a,b){return p(c,b)}:function(a){return Da(a)},
y=function(a,b){return w(a,u(a,b))},z=d(n[2]||n[1]),M=d(n[3]||""),J=d(n[4]||""),D=d(n[8]),x={},u=s?function(a,b){x[s]=b;x[q]=a;return x}:function(a){x[q]=a;return x};return{trackBy:t,getTrackByValue:y,getWatchables:d(D,function(a){var b=[];a=a||[];for(var d=f(a),e=d.length,g=0;g<e;g++){var h=a===d?g:d[g],l=a[h],h=u(l,h),l=w(l,h);b.push(l);if(n[2]||n[1])l=z(c,h),b.push(l);n[4]&&(h=J(c,h),b.push(h))}return b}),getOptions:function(){for(var a=[],b={},d=D(c)||[],g=f(d),h=g.length,n=0;n<h;n++){var p=d===
g?n:g[n],q=u(d[p],p),r=v(c,q),p=w(r,q),s=z(c,q),x=M(c,q),q=J(c,q),r=new e(p,r,s,x,q);a.push(r);b[p]=r}return{items:a,selectValueMap:b,getOptionFromViewValue:function(a){return b[y(a)]},getViewValueFromOption:function(a){return t?ta(a.viewValue):a.viewValue}}}}}var f=v.document.createElement("option"),e=v.document.createElement("optgroup");return{restrict:"A",terminal:!0,require:["select","ngModel"],link:{pre:function(a,b,c,d){d[0].registerOption=C},post:function(d,h,k,l){function m(a,b){a.element=
b;b.disabled=a.disabled;a.label!==b.label&&(b.label=a.label,b.textContent=a.label);b.value=a.selectValue}function n(){var a=J&&r.readValue();if(J)for(var b=J.items.length-1;0<=b;b--){var c=J.items[b];w(c.group)?Hb(c.element.parentNode):Hb(c.element)}J=D.getOptions();var d={};y&&h.prepend(v);J.items.forEach(function(a){var b;if(w(a.group)){b=d[a.group];b||(b=e.cloneNode(!1),A.appendChild(b),b.label=null===a.group?"null":a.group,d[a.group]=b);var c=f.cloneNode(!1)}else b=A,c=f.cloneNode(!1);b.appendChild(c);
m(a,c)});h[0].appendChild(A);s.$render();s.$isEmpty(a)||(b=r.readValue(),(D.trackBy||t?pa(a,b):a===b)||(s.$setViewValue(b),s.$render()))}var r=l[0],s=l[1],t=k.multiple,v;l=0;for(var p=h.children(),z=p.length;l<z;l++)if(""===p[l].value){v=p.eq(l);break}var y=!!v,F=!1,x=B(f.cloneNode(!1));x.val("?");var J,D=c(k.ngOptions,h,d),A=b[0].createDocumentFragment(),u=function(){y?F&&v.removeAttr("selected"):v.remove()};t?(s.$isEmpty=function(a){return!a||0===a.length},r.writeValue=function(a){J.items.forEach(function(a){a.element.selected=
!1});a&&a.forEach(function(a){if(a=J.getOptionFromViewValue(a))a.element.selected=!0})},r.readValue=function(){var a=h.val()||[],b=[];q(a,function(a){(a=J.selectValueMap[a])&&!a.disabled&&b.push(J.getViewValueFromOption(a))});return b},D.trackBy&&d.$watchCollection(function(){if(E(s.$viewValue))return s.$viewValue.map(function(a){return D.getTrackByValue(a)})},function(){s.$render()})):(r.writeValue=function(a){var b=J.selectValueMap[h.val()],c=J.getOptionFromViewValue(a);b&&b.element.removeAttribute("selected");
c?(h[0].value!==c.selectValue&&(x.remove(),u(),h[0].value=c.selectValue,c.element.selected=!0),c.element.setAttribute("selected","selected")):null===a||y?(x.remove(),y||h.prepend(v),h.val(""),F&&(v.prop("selected",!0),v.attr("selected",!0))):(u(),h.prepend(x),h.val("?"),x.prop("selected",!0),x.attr("selected",!0))},r.readValue=function(){var a=J.selectValueMap[h.val()];return a&&!a.disabled?(u(),x.remove(),J.getViewValueFromOption(a)):null},D.trackBy&&d.$watch(function(){return D.getTrackByValue(s.$viewValue)},
function(){s.$render()}));y?(v.remove(),a(v)(d),8===v[0].nodeType?(F=!1,r.registerOption=function(a,b){""===b.val()&&(F=!0,v=b,v.removeClass("ng-scope"),s.$render(),b.on("$destroy",function(){v=void 0;F=!1}))}):(v.removeClass("ng-scope"),F=!0)):v=B(f.cloneNode(!1));h.empty();n();d.$watchCollection(D.getWatchables,n)}}}}],bf=["$locale","$interpolate","$log",function(a,b,d){var c=/{}/g,f=/^when(Minus)?(.+)$/;return{link:function(e,g,h){function k(a){g.text(a||"")}var l=h.count,m=h.$attr.when&&g.attr(h.$attr.when),
n=h.offset||0,r=e.$eval(m)||{},s={},t=b.startSymbol(),v=b.endSymbol(),p=t+l+"-"+n+v,w=$.noop,y;q(h,function(a,b){var c=f.exec(b);c&&(c=(c[1]?"-":"")+R(c[2]),r[c]=g.attr(h.$attr[b]))});q(r,function(a,d){s[d]=b(a.replace(c,p))});e.$watch(l,function(b){var c=parseFloat(b),f=ja(c);f||c in r||(c=a.pluralCat(c-n));c===y||f&&ja(y)||(w(),f=s[c],z(f)?(null!=b&&d.debug("ngPluralize: no rule defined for '"+c+"' in "+m),w=C,k()):w=e.$watch(f,k),y=c)})}}}],cf=["$parse","$animate","$compile",function(a,b,d){var c=
...
if(!l)throw c("iidexp",m);var t=l[3]||l[1],v=l[2];if(r&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(r)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(r)))throw c("badident",r);var p,w,y,z,x={$id:Da};s?p=a(s):(y=function(a,b){return Da(b)},z=function(a){return a});return function(a,d,e,g,l){p&&(w=function(b,c,d){v&&(x[v]=b);x[t]=c;x.$index=d;return p(a,x)});var m=W();a.$watchCollection(n,function(e){var g,n,p=d[0],s,u=W(),x,A,C,B,G,E,K;r&&(a[r]=e);if(na(e))G=
e,n=w||y;else for(K in n=w||z,G=[],e)xa.call(e,K)&&"$"!==K.charAt(0)&&G.push(K);x=G.length;K=Array(x);for(g=0;g<x;g++)if(A=e===G?g:G[g],C=e[A],B=n(A,C,g),m[B])E=m[B],delete m[B],u[B]=E,K[g]=E;else{if(u[B])throw q(K,function(a){a&&a.scope&&(m[a.id]=a)}),c("dupes",h,B,C);K[g]={id:B,scope:void 0,clone:void 0};u[B]=!0}for(s in m){E=m[s];B=xb(E.clone);b.leave(B);if(B[0].parentNode)for(g=0,n=B.length;g<n;g++)B[g].$$NG_REMOVED=!0;E.scope.$destroy()}for(g=0;g<x;g++)if(A=e===G?g:G[g],C=e[A],E=K[g],E.scope){s=
p;do s=s.nextSibling;while(s&&s.$$NG_REMOVED);E.clone[0]!==s&&b.move(xb(E.clone),null,p);p=E.clone[E.clone.length-1];f(E.scope,g,t,C,v,A,x)}else l(function(a,c){E.scope=c;var d=k.cloneNode(!1);a[a.length++]=d;b.enter(a,null,p);p=d;E.clone=a;u[E.id]=E;f(E.scope,g,t,C,v,A,x)});m=u})}}}}],df=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(b,d,c){b.$watch(c.ngShow,function(b){a[b?"removeClass":"addClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],Xe=["$animate",function(a){return{restrict:"A",
...
if(!h)throw ph("orphan",Aa(b));e.ngTransclude===e.$attr.ngTransclude&&(e.ngTransclude="");e=e.ngTransclude||e.ngTranscludeSlot;h(function(a,c){a.length?b.append(a):(k(),c.$destroy())},null,e);e&&!h.isSlotFilled(e)&&k()}}}}],Le=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(b,d){"text/ng-template"===d.type&&a.put(d.id,b[0].text)}}}],qh={$setViewValue:C,$render:C},rh=["$element","$scope",function(a,b){var d=this,c=new Ta;d.ngModelCtrl=qh;d.unknownOption=B(v.document.createElement("option"));
d.renderUnknownOption=function(b){b="? "+Da(b)+" ?";d.unknownOption.val(b);a.prepend(d.unknownOption);a.val(b)};b.$on("$destroy",function(){d.renderUnknownOption=C});d.removeUnknownOption=function(){d.unknownOption.parent()&&d.unknownOption.remove()};d.readValue=function(){d.removeUnknownOption();return a.val()};d.writeValue=function(b){d.hasOption(b)?(d.removeUnknownOption(),a.val(b),""===b&&d.emptyOption.prop("selected",!0)):null==b&&d.emptyOption?(d.removeUnknownOption(),a.val("")):d.renderUnknownOption(b)};
d.addOption=function(a,b){if(8!==b[0].nodeType){Sa(a,'"option value"');""===a&&(d.emptyOption=b);var g=c.get(a)||0;c.put(a,g+1);d.ngModelCtrl.$render();b[0].hasAttribute("selected")&&(b[0].selected=!0)}};d.removeOption=function(a){var b=c.get(a);b&&(1===b?(c.remove(a),""===a&&(d.emptyOption=void 0)):c.put(a,b-1))};d.hasOption=function(a){return!!c.get(a)};d.registerOption=function(a,b,c,h,k){if(h){var l;c.$observe("value",function(a){w(l)&&d.removeOption(l);l=a;d.addOption(a,b)})}else k?a.$watch(k,
...
a.push(b.value)});return a};e.writeValue=function(a){var c=new Ta(a);q(b.find("option"),function(a){a.selected=w(c.get(a.value))})};var g,h=NaN;a.$watch(function(){h!==f.$viewValue||pa(g,f.$viewValue)||(g=ma(f.$viewValue),f.$render());h=f.$viewValue});f.$isEmpty=function(a){return!a||0===a.length}}}},post:function(a,b,d,c){var f=c[1];if(f){var e=c[0];f.$render=function(){e.writeValue(f.$viewValue)}}}}}},Ne=["$interpolate",function(a){return{restrict:"E",priority:100,compile:function(b,d){var c,f;
...
c){var f=a|0,e=c;void 0===e&&(e=Math.min(b(a),3));Math.pow(10,e);return 1==f&&0==e?"one":"other"}})}]),B(v.document).ready(function(){xe(v.document,Jc)}))})(window);!window.angular.$$csp().noInlineStyle&&window.angular.element(document.head).prepend(window.angular.element("<style>").text('@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}'));
/*! RESOURCE: /scripts/angular_supported/angular-sanitize.min.js */
/*
 AngularJS
 (c) 2010-2020 Google LLC. http://angularjs.org
 License: MIT
 XLTS for AngularJS v1.5.16
...
angular.module("ng.amb").factory("AMBOverlay", function($templateCache, $compile, $rootScope, i18n) {
	"use strict";
	var showCallbacks = [],
		beforeShowCallbacks = [],
		hideCallbacks = [],
...
show: true
	...
	function AMBOverlay(config) {
		...
		i18n.getMessage("Login", function(msg) {
			config.loginMessage = msg;
		});
		function lazyRender() {
...
'				<h4 id="small_modal1_title" class="modal-title">{{loginMessage}}</h4>' +
'			</header>' +
		'			<div class="modal-body">' +
'			<iframe class="concourse_modal" ng-src=\'{{iframe || "/amb_login.do"}}\' frameborder="0" height="400px" width="405px"></iframe>' +
'			</div>' +
'		</div>' +
'	</div>' +
'</div>'
...
angular.module('sn.common.datetime').directive("snTimeAgo", function(timeAgoSettings, $rootScope, timeAgo, timeAgoTimer, DATE_GRANULARITY, dateUtils) {
	...
	return {
		restrict: "E",
template: '<time title="{{ ::titleTime }}" tabindex="0"><span aria-hidden="true">{{timeAgo}}</span><span class="sr-only">{{timeAgoVerbose}}</span></time>',
		scope: {
			timestamp: "=",
local: "="
		},
...
window.open('/nav_to.do?uri=' + encodeURIComponent('sys_user.do?sys_id=' + scope.users[0].userID), '_blank');
			...
			controller: ['$scope', 'liveProfileID', function($scope, liveProfileID) {
				...
				$scope.onPresenceChange = function(status) {
					$scope.presenceStatus = status;
				}
...
return $http.get('/api/now/live/profiles/sys_user.' + $scope.primary).then(function (response) {
								$scope.users = [{
									userID: $scope.primary,
									name: response.data.result.name,
									initials: response.data.result.initials ? response.data.result.initials : buildInitials(response.data.result.name),
									avatar: response.data.result.avatar
								}];
								return setPresence();
							});
		...
		link : function (scope, element, attrs) {
			...
			function render(){
				...
				$timeout(function(){
					...
					$(".select2-focusser").attr("aria-expanded", "false");
				});
			}
			init();
...
link.type = "text/css";
	...
	function encapsulate(root, content, uniqueId) {
		...
		if (document.head.createShadowRoot || document.head.attachShadow) {
			...
			if (NOW.isUsingPolaris) contentDiv.classList.add('-polaris');
...
markup += "<div style='width: " + width + "%;' class='select2-result-cell'>" + escapeHtml(displayValues[i])  + "</div>";
			...
			var config = {
				...
				ajax: {
					...
					data: function(filterText, page) {
						...
						var referenceKey = _getReferenceKey(scope);
						if (referenceKey) {
							params.reference_key = referenceKey;
						}
						if (scope.domain) {
			...
			function _getReferenceKey(scope) {
				if (scope.ed && scope.ed.referenceKey) {
					return scope.ed.referenceKey;
				}
				if (scope.field && scope.field.referenceKey) {
					return scope.field.referenceKey;
				}
				return null;
			}
			...
			function select2Change(e) {
				...
				if (e.added) {
					...
					var value = selectedItem.$$referenceKeyValue || selectedItem.sys_id;
...
var url = '/api/now/table/' + scope.table + '?' + urlTools.encodeURIParameters(queryParams.data);
			...
			function buildQuery(filterText, searchFields, defaultQuery) {
				var queryParts = [];
				var operator;
				if (window.g_ref_ac_startswith || scope.startswith)
					operator = "STARTSWITH";
				else
					operator = "CONTAINS";
...
OR = "OR";
				...
				if (defaultQuery && typeof(defaultQuery) == 'string' && defaultQuery.indexOf('ORDERBY') != -1)
					queryParts.push(defaultQuery);
...
$select.bind("sn-atf-setvalue", onAtfSetValue);
					...
					select2Container.find(".select2-focusser").attr("aria-label", getAriaLabel()).attr("aria-controls", "select2-drop");
					select2Container.find("ul.select2-results").attr("aria-label", scope.snAriaLabel || scope.field.name || scope.table);
					updateAriaExpanded(false);
					if (!scope.multiple) {
						var closeButton = select2Container.find('.select2-search-choice-close');
						var clearTitle = getAriaClearLabel();
						closeButton.attr({'aria-label': clearTitle, 'title': clearTitle,
						'tabindex': 0, 'role': 'button', 'data-toggle': 'tooltip',  'data-container': 'body'});
						closeButton.on('keydown', function(e) {
							if (e.which === 13 || e.which === 32)
								element.select2('val', '', true);
						});
						select2Focusser = select2Container.find('.select2-focusser')[0];
						var anchorEle = select2Container.find('.select2-choice')[0];
						select2Focusser.parentNode.insertBefore(select2Focusser, anchorEle);
					}
				});
			}
			function getAriaClearLabel() {
				var field = scope.field;
				var label = scope.snAriaLabel || field.name || scope.table;
				return i18n.format(i18n.getMessage('Clear field {0}'), label);
			}
			function getAriaLabel() {
				var label = "", field = scope.field;
				label += scope.snAriaLabel || field.name || scope.table;
...
scope.$emit("field.change." + f.name, p);
				...
				if (e.added) {
					...
					if (!scope.multiple){
					 ...
					 if (!scope.multiple) {
						...
						scope.field.value = '';
						setTimeout(function(){
							select2Focusser.focus();
						});
					}
				}
				select2Container.find(".select2-focusser").attr("aria-label", getAriaLabel());
				scope.$apply(function() {
					callChange(oldValue, e);
				});
			}
			...
			function updateAriaExpanded(isOpen) {
				var select2Parent = element.data('select2');
				if (scope.multiple)
					select2Parent.container.find(".select2-choices input[role='combobox']").attr("aria-expanded", isOpen);
				else
					select2Parent.focusser.attr("aria-expanded", isOpen);
			}
...
$timeout(schedulePresence);
	...
	function suspendWatch(flag) {
		if (flag !== undefined)
			_suspendWatch = flag;
		return _suspendWatch;
	}
			...
			function updatePresence () {
				...
				if (presences[id]) {
					...
					if (status === 'maybe offline' || status === 'probably offline') {
						...
						scope.onPresenceChange({"status": presenceStatus.away});
						...
						scope.onPresenceChange({"status": presenceStatus.offline});
						...
						scope.onPresenceChange({"status": presenceStatus.online});
					}
...
angular.module("sn.common.stream").controller("Stream", function($rootScope, $scope, snRecordWatcher, $timeout) {
	...
	var recordWatchSubscribed = false;
	...
	if (isForm) {
		$timeout(function() {
			var formQuery = "sys_id=" + NOW.sysId;
			snRecordWatcher.initChannel(NOW.targetTable, formQuery, function(message) {
				$rootScope.$broadcast("sn.stream.tap", message.data);
				recordWatchSubscribed = true;
			});
		}, 100);
	}
	else {
		$rootScope.$on('sn.stream.entries_change', function(evt, entries) {
			if (recordWatchSubscribed) 
				return; 
			
			var listQuery =  entries
						.filter(function (entry) {return entry.document_id;})
						.map(function (entry) {return entry.document_id;})
						.join(",");
			if (!listQuery)
				return;
			snRecordWatcher.initChannel(NOW.targetTable, "sys_idIN" + listQuery, function(message) {
				$rootScope.$broadcast("sn.stream.tap", message.data);
				recordWatchSubscribed = true;
			});		
		})
...
$scope.allFields = null;
			...
			i18n.getMessages(
				...
				function (results) {
					...
					was = results[was];
					emailBodyMsg = results[emailBodyMsg];
...
journal.sanitized_new_value = journal.new_value = response.data.result.replace(/\n/g, '<br/>');
			...
			$scope.postJournalEntryForCurrent = function(event) {
				...
				if ($scope.multipleInputs) {
					...
					var inputType = ($scope.inputType === 'comments' || $scope.inputType === 'work_notes') ? $scope.inputType : 'custom';
					window.GlideUXMetrics && GlideUXMetrics.track('Post Activity', {
						'type': inputType
					});
				}
...
if (formValue && formValue.indexOf($window.NOW.STREAM_VALUE_KEY) !== 0) {
		   ...
		   function focusCollapseButton() {
			   var collapseButton = document.querySelector('.sn-stream #multiple-input-journal-entry button.icon-stream-one-input');
			   if (collapseButton) {
			...
			function processEntries(entries) {
				...
				angular.forEach(entries, function (entry) {
					...
					if (entry.attachment) {
						...
						entry.email = {};
						entry.emailBodyMsg = emailBodyMsg;
...
if (attachment.content_type.startsWith('image/') && attachment.content_type.indexOf("tiff") < 0
			...
			function extractJournalEntries(oneLargeEntry) {
				...
				if (oneLargeEntry.entries.journal.length === 0)
					return oneLargeEntry;
				for (var i = 0; i < oneLargeEntry.entries.journal.length; i++) {
					if (verifyDuplicateJournals(oneLargeEntry.entries.journal[i].sys_id))
						continue;
			...
			function verifyDuplicateJournals(journalSysId){
				return $scope.entries.some(function(entry) {
					if (entry.entries.journal)
						return entry.entries.journal.some(function(journal) {
							return journal.sys_id == journalSysId;
						});
				});
			}
...
markListBoxAsFocused('activity_filter_all', false);
			...
			filterPopoverButton.on("hidden.bs.popover", function() {
				$scope.$apply(function () {
					$scope.filterOpen = false;
					if ($scope.filterModified) {
						captureFilterMetrics();
						$scope.filterModified = false;
					}
				});
...
if (evt.keyCode === 38 || (evt.shiftKey && evt.keyCode === 9)) {
			...
			function captureFilterMetrics() {
				if (GlideUXMetrics) {
					var selectedFields = $scope.allFields
						.filter(function(field) {return field.isActive})
						.map(function(field) {return field.name})
						.sort()
						.join();
					var unselectedFields = $scope.allFields
						.filter(function(field) {return !field.isActive})
						.map(function(field) {return field.name})
						.sort()
						.join();
					GlideUXMetrics.track('Filter Activity Selected Fields', {
						table: $scope.table,
						fields: selectedFields
					});
					GlideUXMetrics.track('Filter Activity Unselected Fields', {
						table: $scope.table,
...
template: "<iframe style='width: 100%;' class='card activity-stream-email-iframe' src='{{::emailBodySrc}}' title='{{::emailBodyMsg}}'></iframe>",
		controller: function($scope){
...
'<div class="popover glide-popup" role="tooltip" style="max-width:650px"><div class="arrow"></div><div class="popover-content" style="width:650px;"></div></div>';
        ...
        function _getContainer($target) {
            ...
            var container = $(".section_header_content_no_scroll");
            if (container.length > 0) {
                return container;
            }
            container = $("#item_table");
            if (container.length > 0) {
                return container;
            }
            return $("body");
    ...
    function showPopup(evt, url, options) {
        ...
        if (document && url) {
			['sysparm_domain', 'sysparm_domain_scope'].forEach(function(id) {
				var elm = document.getElementById(id);
				if (elm && url.indexOf(id + '=') < 0)
					url += (url.endsWith('&') ? '' : '&') + id + '=' + elm.value;
			});
        }
    ...
    function deactivateAndDestroyFocusTrap(popup) {
        ...
        try {
            focusTrap.deactivate({
                returnFocus: true,
                returnFocusTo: document.activeElement !== document.body && !popup.contains(document.activeElement) && document.activeElement
            });
        } catch (e) {
            console.warn("Unable to deactivate focus trap", e);
        }
    ...
    function popListDiv(
        ...
        if (useHref) {
        	contentURL.addParam("sysparm_elem_href", fixedEncodeURIComponent(elemHref));
        }
...
return str.replace(/[!'()*]/g, function(c) {
    ...
    function popDiv(evt, params) {
        evt.preventDefault();
        var contentURL = new GlideURL("service_catalog.do");
        contentURL.addParam("sysparm_action", "popup");
        contentURL.addParam("sysparm_glide_popup", "true");
        if (typeof params != "object") {
        		contentURL.addParam("sysparm_sys_id", params);
        }
        else {
        	var param;
        	for (param in params)
        		contentURL.addParam(param, params[param]);        	
        }       
...
$j(function() {
	...
	var $container = $j($moreOptionsButton.data("target"));
	$moreOptionsButton.popover({
		html: true,
		placement: 'bottom'
		...
		$container.css({'max-height': popoverMaxHeight + 'px'});
		this.setAttribute("aria-expanded", "true");
		if ($container.find("button").length > 0)
			$container.find("button")[0].focus();
		isOpen = true;
	...
	$container.keyup(function(e) {
		if (e.keyCode === $j.ui.keyCode.ESCAPE) {
			$moreOptionsButton.popover("hide");
			$moreOptionsButton.setAttribute("aria-expanded", "false");
			$moreOptionsButton.focus();
		}
	});
	$j(document).keyup(function(e) {
		if (isOpen && e.keyCode === $j.ui.keyCode.TAB && $container.find(e.target).length === 0 && !(e.target.closest("#tag_form"))) {
			$moreOptionsButton.popover("hide");
		}
	});
});
